# Source: https://learn.microsoft.com/en-us/gaming/gdk/docs/gdk-dev/pc-dev/tutorials/pc-e2e-guide/e2e-creating-partnercenter-account?view=gdk-2604

Table of contents Exit editor mode

Ask Learn Ask Learn

Reading mode Table of contents [Read in English](https://learn.microsoft.com/en-us/gaming/gdk/docs/gdk-dev/pc-dev/tutorials/pc-e2e-guide/e2e-creating-partnercenter-account?view=gdk-2604) Add to Collections Add to plan [Edit]()
...
Before you can test Xbox services functionality or publish a game to the Microsoft Store, you need to create an account and a product in Partner Center.

Watch our video tutorial to learn how to complete the process. 
 

If you would like to provide feedback about this video, select [here](https://aka.ms/VideoFB).

## Types of Partner Center developer accounts
...
| --- | --- |
| 
- **Independent developers** whose distribution of apps through the Microsoft Store is **not in relation to their business, trade, or profession**
...
See [Developer accounts](https://learn.microsoft.com/en-us/windows/apps/publish/partner-center/partner-center-developer-account) for additional information.
...
1. Go to the Partner Center registration [page](https://partner.microsoft.com/dashboard/registration/AccountInfo?accountProgram=AppDev) in a private window/tab and sign in with a Microsoft account.
 
2. Enter the email address you want to use for registration and click **Next**.
 
3. Enter a password for your new account and click **Next**.
 
4. Enter your Country/region and your birth date and then click **Next**.
 
5. An email will be sent to you to verify your email address. Enter the code in the email and click **Next**.
 
6. Verify the account being shown in the welcome screen is the account you want to use and then click **Next**.
 
7. On the **Join a program to unlock new opportunities** screen, select **Windows and Xbox** under **Looking to partner on** and then click **Next**.
 
8. On the **Account Information** page that appears, select the country/region for your account and specify whether your account type is an _individual_ account or a _company_ account.
 
 Warning
 
 You **can't** change your account type after your account is created. If you're unsure which account type to pick, see [Developer accounts](https://learn.microsoft.com/en-us/windows/apps/publish/partner-center/partner-center-developer-account) for a description of each account type.
 
9. Provide your individual information or your company's legal business details depending on whether you selected an individual account or company account.
 ...
 **If you are creating a company account:**
 ...
 You will also need to enter information for the [primary contact](https://learn.microsoft.com/en-us/partner-center/enroll/mpn-create-a-partner-center-account#prerequisites-for-enrolling) at your company. The primary contact is the person in your company we can contact about your application (this contact can be you or another person in your company).
 
 Note
 
 The email address for the primary contact for your company must be a business email address.
 
 In some countries/regions and scenarios, you may be required to provide a registration ID number for your business. See [Registration ID numbers by country/region](https://learn.microsoft.com/en-us/partner-center/enroll/mpn-create-a-partner-center-account#registration-id-numbers-by-countryregion) for more information.
 
10. Click **Accept and continue**
 
11. Enter your payment information in the **Registration payment** page.
 
12. Click **Pay now and Register**
...
For more information about the verification process, see [Verify your account information when you enroll in a new Partner Center program](https://learn.microsoft.com/en-us/partner-center/enroll/verification-responses).
...
3. Select Legal Info to view your company's legal details, your verification status, your PartnerIDs and also create new Partner Program locations if needed.
...
1. In Partner Center, select **Settings -> Account settings -> Tenants**
2. Choose **Associate Microsoft Entra ID** and pick one:
...
3. While logged in with the account you used to create your Partner Center account, associate your Partner Center account with the Entra tenant from the previous step.
4. Open **Settings -> Account settings -> Users** and add an Entra user to use for the global admin role.
5. Assign the new Entra user to the global admin role.
6. Sign in with your new user by going to Account Settings -> User management, and clicking **Sign in with Microsoft Entra ID**.
7. Use the new Entra user account anytime you sign into Partner Center.

## Add teammates with Microsoft Entra ID

Once your Partner Center account is approved, you can give coworkers their own logins:
...
2. Choose **Associate Microsoft Entra ID** and pick one:
 ...
 - Use existing tenant – sign in as a Global/Account admin for that tenant and select Confirm
 - Create free tenant – follow the quick wizard (opens Microsoft Entra admin center in a new tab), then return and confirm.
3. Back in Partner Center, open **Settings -> Account settings -> Users** to add employees or service principals and assign roles
 

For more information see [Set up a Microsoft Entra ID to sign in to Partner Center](https://learn.microsoft.com/en-us/partner-center/account-settings/azure-active-directory-tenants-and-partner-center).

## Next step

[Step 3 - Creating an initial product definition in Partner Center](https://learn.microsoft.com/en-us/gaming/gdk/docs/gdk-dev/pc-dev/tutorials/pc-e2e-guide/e2e-creating-partnercenter-product-definition?view=gdk-2604)
