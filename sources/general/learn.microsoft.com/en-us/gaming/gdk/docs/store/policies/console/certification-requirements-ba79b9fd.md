# Source: https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/console/certification-requirements?view=gdk-2604

Table of contents Exit editor mode

Ask Learn Ask Learn

Reading mode Table of contents [Read in English](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/console/certification-requirements?view=gdk-2604) Add to Collections Add to plan [Edit]()
...
- For XRs tested in Certification, view the test cases here: [Xbox Requirements and Test Cases](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/console/console-certification-requirements-and-tests?view=gdk-2604).
...
### [XR-006: Title Assets and Metadata](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr006?view=gdk-2604)
...
### [XR-007: Cross-Network Play, Data Usage, and Companion App Interactions](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr007?view=gdk-2604)
...
- Titles must restrict cross-network communication based on Xbox network safety settings, as detailed in [XR-015: Managing Player Communication](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr015?view=gdk-2604) and [XR-045: Xbox network and Account Privileges](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr045?view=gdk-2604).
...
Beyond [XR-018: User-Generated Content](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr018?view=gdk-2604), content from non-Xbox network users must be one of the following:
...
### [XR-083: XDK / GDK Versions](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr083?view=gdk-2604)
...
### [XR-109: Linking Between Apps](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr109?view=gdk-2604)
...
For more information on in game commerce with the GDK, read the [Commerce section](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/commerce/commerce-nav?view=gdk-2604)
...
### [XR-062: Achievement Names and Descriptions](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr062?view=gdk-2604)
...
[XR-007: Cross-Network Play, Data Usage, and Companion App Interactions](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr007?view=gdk-2604) has been updated to focus solely on business policy, with the technical requirements removed. |
