# Source: https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/console/console-certification-requirements-and-tests?view=gdk-2604

Table of contents Exit editor mode

Ask Learn Ask Learn

Reading mode Table of contents [Read in English](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/console/console-certification-requirements-and-tests?view=gdk-2604) Add to Collections Add to plan [Edit]()
...
- This page defines the XRs for the Xbox console games tested in Xbox Certification. For a list of all XRs, including those not tested in Xbox Certification, go to [Xbox Requirements](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/console/certification-requirements?view=gdk-2604).
- For a summary of the changes in this release, see [changes in this release](https://learn.microsoft.com/#changes) at the bottom of this page.
...
- View the [top ten failing test cases](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/console/console-topfailingtestcases?view=gdk-2604) on console.

Important

The Certification team now conducts testing exclusively on retail consoles in the CERT sandbox for all [Final submissions](https://learn.microsoft.com/en-us/gaming/game-publishing/concepts/certification/certification-guide). Previously, some test cases relied on GDK commands executed on Xbox development kits. These cases have been revised to use only steps available on retail consoles. [Optional submissions](https://learn.microsoft.com/en-us/gaming/game-publishing/concepts/certification/certification-optional-submissions) are still tested on development kits in the CERT.DEBUG sandbox.

#### Testing suspend and resume

Refer to [Xbox Game Life CycleAuthorization required](https://learn.microsoft.com/en-us/gaming/gdk/docs/gdk-dev/console-dev/overviews/xbox-game-life-cycle?view=gdk-2604) for a detailed look at the concepts and events that make up the game life cycle. It demonstrates how to implement game state and state-change events in your game.
...
Refer to the [console test bench guide](https://learn.microsoft.com/#CONSOLEBENCH) at the bottom of this page to set up your consoles.
...
### [XR-130: Xbox Console Families and Generations](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr130?view=gdk-2604) \*
...
- Between generations (Xbox One and Xbox Series X|S), games which share the same TitleID must:
 - Support game save roaming for content available on both generations ([XR-052: User State and Title-Save Location, Roaming and Dependencies](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr052?view=gdk-2604)).
...
### [XR-131: Display Mode Support for Game DVR and Screenshots](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr131?view=gdk-2604) \*
...
Titles must use the naming standards defined in the latest release of the [Terminology List](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/console/console-certification-terminology?view=gdk-2604) for Xbox console and/or Xbox network features.
...
- [Fiddler on console](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/console/networking/tools/fiddler-setup-networking?view=gdk-2604) or [Fiddler on PC](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/console/networking/tools/fiddler-pc?view=gdk-2604)
...
![Image of Game Event Limitations system toast](https://learn.microsoft.com/../../../../media/public-images/policies/eventlimitationtoast.jpg?view=gdk-2604)
...
For more information on local storage on Xbox consoles with the GDK, read the [Local Storage section](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/console/storage/local-storage?view=gdk-2604)
...
### [XR-014: Player Data and Personal Information](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr014?view=gdk-2604) \*
...
1. The title transmits and shares a user's personal information with users on other consoles. _Examples_: Email address, location (anything more specific than state/country/region), name, date of birth, profile passcode, secret question, password(s), credit card details.
...
### [XR-017: Title Ratings](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr017?view=gdk-2604) \*

**Title Ratings for Xbox**

This [white paper](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr017?view=gdk-2604) focuses on two essential concepts as they pertain to content classifications and restrictions on Xbox consoles:
...
For digital only titles or for testing without green discs please instead refer to test case [BVT 000-13](https://learn.microsoft.com/#bvt-13-age-rating-validation).
...
For more information on Streaming Install or Intelligent Delivery with the GDK, read the [Streaming Install and Intelligent Delivery](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/overviews/streaming_install-intelligent_delivery?view=gdk-2604) overview.
...
### [XR-129: Intelligent Delivery Content Management](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr129?view=gdk-2604) \*
...
For more information on Streaming Install or Intelligent Delivery with the GDK, read the [Streaming Install and Intelligent Delivery overview](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/overviews/streaming_install-intelligent_delivery?view=gdk-2604)
...
### [XR-123: Installation/Unlock of Game Add-Ons or Consumables During Gameplay](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr123?view=gdk-2604) \*
...
For more information on accessing and enumerating DLC in game, read the [Downloadable content (DLC) packages section](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/packaging-downloadable-content-dlc?view=gdk-2604)
...
#### [XR-037: Dependencies on Content Packages](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr037?view=gdk-2604) \*
...
### [XR-036: In-Title Pricing Information](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr036?view=gdk-2604) \*
...
For more information on in game commerce with the GDK, see [Commerce](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/commerce/commerce-nav?view=gdk-2604).
...
### [XR-112: Establishing a User and Controller During Initial Activation and Resume](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr112?view=gdk-2604) \*
...
### [XR-115: Addition and Removal of Users or Controllers During Gameplay](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr115?view=gdk-2604) \*
...
### [XR-047: User Profile Access](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr047?view=gdk-2604) \*
...
The following table shows which test cases apply to your title if using the GDK Simplified User Model or the GDK Advanced User Model, ERA and UWP Multiple User Applications. Refer to [XR-112](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/xr/xr112?view=gdk-2604) for additional details regarding the use of the Simplified User Model versus the Advanced User Model.
...
For information on using the friends list using the GDK, read the [People System (Friends List) overview](https://learn.microsoft.com/en-us/gaming/gdk/docs/services/community/people-system/live-people-system-nav?view=gdk-2604)
...
The requirements in this category apply only to titles classified as betas or Game Previews. For other store policies and for program-specific definitions of open and closed betas, size limitations, duration, pricing, metadata, and offers, reach out to your [Microsoft contacts](https://learn.microsoft.com/en-us/gaming/game-publishing/resources/managed-support/overview-microsoft-representatives-and-contacts).

Beta and Game Preview titles are subject to a subset of the XRs presented in this document. The scope of this subset is detailed in the [Xbox Requirements for Game Previews and Betas page](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/policies/certification-requirements-beta-game-preview?view=gdk-2604).
...
> Reach out to your [Microsoft contancts](https://learn.microsoft.com/en-us/gaming/game-publishing/resources/managed-support/overview-microsoft-representatives-and-contacts) for the steps to file Exceptions.
...
| --- | --- | --- |
| November 1, 2025 | 16.0 | Updated the following test cases that contain steps to suspend the game to use steps only available on Retail consoles. 
