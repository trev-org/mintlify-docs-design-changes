# Source: https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/creating-test-compilation-discs?view=gdk-2604

Table of contents Exit editor mode

Ask Learn Ask Learn

Reading mode Table of contents [Read in English](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/creating-test-compilation-discs?view=gdk-2604) Add to Collections Add to plan [Edit]()
...
- [Compilations](https://learn.microsoft.com/#ID4E1)
- [Multi-discs](https://learn.microsoft.com/#ID4EBE)
...
- [Create a disc layout](https://learn.microsoft.com/#ID4EGB)
- [Catalog.js](https://learn.microsoft.com/#ID4EMC)
- [Installation ordering and notifications](https://learn.microsoft.com/#ID4ELD)
- [Deploying](https://learn.microsoft.com/#ID4EYD)
...
- [Franchise Game Hubs](https://learn.microsoft.com/en-us/gaming/gdk/docs/store/franchise-game-hubs?view=gdk-2604)
