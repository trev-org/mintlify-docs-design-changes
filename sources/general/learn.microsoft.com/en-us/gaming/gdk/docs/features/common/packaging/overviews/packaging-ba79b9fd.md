# Source: https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/overviews/packaging?view=gdk-2604

Table of contents Exit editor mode

Ask Learn Ask Learn

Reading mode Table of contents [Read in English](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/overviews/packaging?view=gdk-2604) Add to Collections Add to plan [Edit]()
...
[Getting started packaging for Xbox consoles](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/overviews/packaging-getting-started-for-console?view=gdk-2604)
...
Package uploading and publishing can be automated by using the Package Uploader open-source tool. Package Uploader is a .NET 5.0-based cross-platform application and library that enables game developers to interact programmatically with Partner Center. For more information, see [Automating package uploading](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/package-uploader?view=gdk-2604).

For more information about installing apps, see [Streaming Installation and Intelligent Delivery: an overview](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/overviews/streaming_install-intelligent_delivery?view=gdk-2604).

## MSIXVC2 for PC

Starting with the April 2026 GDK, a next-generation packaging format called MSIXVC2 is available as a preview for PC games. MSIXVC2 delivers dramatically smaller content updates (64–94% reduction), faster packaging (up to 7.6x), and a simplified workflow that can combine packaging and uploading into a single command.

MSIXVC2 is PC-only. Console games continue to use XVC. The `makepkg2` tool supports both formats.

For details, see [MSIXVC2 packaging overview](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/overviews/packaging-msixvc2-overview?view=gdk-2604).

## See also

[Packaging](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/gc-packaging-toc?view=gdk-2604) 
...
[Deploying your title to your Xbox dev kit (NDA topic)Authorization required](https://learn.microsoft.com/en-us/gaming/gdk/docs/gdk-dev/console-dev/dev-kits/concepts/deployment?view=gdk-2604) 
