# Source: https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/overviews/intelligentdelivery?view=gdk-2604

Table of contents Exit editor mode

Ask Learn Ask Learn

Reading mode Table of contents [Read in English](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/overviews/intelligentdelivery?view=gdk-2604) Add to Collections Add to plan [Edit]()
...
The [Deployment Schema](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/deployment/atoc-deployment-schema?view=gdk-2604) article contains examples for using Intelligent Delivery to define Chunks with specifiers and Features that control their installation.

Intelligent Delivery offers the following capabilities to group content and control when it's installed.

- [Features and recipes](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/intelligentdelivery-features-recipes?view=gdk-2604) 
...
- [Device specifiers](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/intelligentdelivery-device?view=gdk-2604) 
 Declares the types of devices to which the content in a specific chunk applies.
 
- [Language specifiers](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/intelligentdelivery-language?view=gdk-2604) 
 Declares the language to which the content in a chunk applies.
 
- [Custom tags](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/intelligentdelivery-custom?view=gdk-2604) 
...
- [OnDemand content](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/intelligentdelivery-ondemand?view=gdk-2604) 
...
[Intelligent Delivery: Features and Recipes](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/intelligentdelivery-custom?view=gdk-2604) 
Describes how to use Intelligent Delivery Features to allow end users to choose which parts of your game to install.

[Intelligent Delivery: Custom tag specifiers](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/intelligentdelivery-custom?view=gdk-2604) 
Describes how to use Intelligent Delivery to support multi-disc and other complex installation scenarios.

[Intelligent Delivery: devices specifiers](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/intelligentdelivery-device?view=gdk-2604) 
Describes how to use Intelligent Delivery to specify the devices on which a chunk is to be installed.

[Intelligent Delivery: language specifiers](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/intelligentdelivery-language?view=gdk-2604) 
Describes how to use Intelligent Delivery to specify the language-specific assets to be installed on a console.

[Intelligent Delivery: OnDemand content](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/intelligentdelivery-ondemand?view=gdk-2604) 
...
[Dynamic chunk reordering](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/packaging-chunkreordering?view=gdk-2604) 
...
[Streaming installation: debugging](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/packaging-debugging?view=gdk-2604) 
Describes how to connect a debugger to your installation process.

[Streaming installation: status](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/packaging-installstatus?view=gdk-2604) 
...
[Creating a disc subset](https://learn.microsoft.com/en-us/gaming/gdk/docs/features/common/packaging/packaging-disc-subset?view=gdk-2604) 
