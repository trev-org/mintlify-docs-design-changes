# Source: https://learn.microsoft.com/en-us/gaming/gdk/docs/tools/tools-services/live-xbox-live-account-tool?view=gdk-2604

Table of contents Exit editor mode

Ask Learn Ask Learn

Reading mode Table of contents [Read in English](https://learn.microsoft.com/en-us/gaming/gdk/docs/tools/tools-services/live-xbox-live-account-tool?view=gdk-2604) Add to Collections Add to plan [Edit]()
...
- Make Xbox services authenticated http calls.

## Where can I find the Xbox Live Test Account tool?

This command-line tool is part of the GDK and `XboxLiveTools.zip`; see [Development tools for Xbox services](https://learn.microsoft.com/en-us/gaming/gdk/docs/tools/tools-services/live-tools?view=gdk-2604).
...
Navigate to the **Gamertag** tab and enter a [modern gamertag](https://learn.microsoft.com/en-us/gaming/gdk/docs/services/fundamentals/identity/user-profile/gamertags/live-modern-gamertags-overview?view=gdk-2604). From your input, a [classic gamertag](https://learn.microsoft.com/en-us/gaming/gdk/docs/services/fundamentals/identity/user-profile/gamertags/live-classic-gamertags-overview?view=gdk-2604) will also be generated.

Dev account classic gamertags will always start with a 2.

Only one change is currently supported per account.
...
- [Creating test accounts](https://learn.microsoft.com/en-us/gaming/gdk/docs/services/develop/test-accounts/live-setup-testaccounts?view=gdk-2604)
