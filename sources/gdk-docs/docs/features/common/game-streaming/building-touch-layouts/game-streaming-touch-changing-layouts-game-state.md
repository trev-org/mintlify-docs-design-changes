...
Initial state at the launch of the game is defined by the [default state](../game-streaming-touch-touch-adaptation-bundle.md#context) that was included in the Touch Adaptation Bundle. In the touch control layout, the control should reference the state for the property that may be changed at runtime.
