...
The [xbstress tool (NDA topic)](../../../tools/tools-console/commandlinetools/xbstress.md) makes it easy for you to simulate different network conditions for your users by adding additional latency.
