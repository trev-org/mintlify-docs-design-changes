...
__Visual C/C++ version__ | __Recommendation__
--- | ---
...
Remember that the VS 2015 Update 3, VS 2017, VS 2019, and VS 2022 all use the same REDIST, with the VS 2022 being the latest one. See [Microsoft Docs](/cpp/porting/binary-compat-2015-2017) for more information.
