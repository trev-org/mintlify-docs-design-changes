...
If your package has any of the following properties or needs any of the following features, see the [Other packaging considerations and advanced features](#msixvc_advanced_features) section later in this article.
...
A sample MicrosoftGame.config xml file is included [later in this article](#sample). Use this sample as a reference alongside the [MicrosoftGame.config Editor](../../game-config/MicrosoftGameConfig-Editor.md), which streamlines creation of your .config file and automatically syncs down ID and name values from your Partner Center project.


## Identify any Visual C/C++ runtime dependencies

Identify any Visual C/C++ runtime dependencies of your package. Ensure they're listed as dependencies in your MicrosoftGame.config or are explicitly copied into your package payload. For more information, see [Framework package dependencies](../packaging-framework-packages.md).
...
This command creates a file called `layout.xml` (this file name is the suggested name, but you can use any other name). Use this file during the packaging step. For more information on packaging tools, see [Make package (makepkg.exe)](../deployment/makepkg.md).
...
1. Enter **Developer** in the search field. From the options displayed, select **Use developer features**.

1. Select **Developer mode**. A dialog box appears, saying that the system is adding some features. Before moving beyond this step, wait for this process to finish.
...
While you can manually create the MicrosoftGame.config, the best way to create this file is by using the [MicrosoftGame.config Editor](../../game-config/MicrosoftGameConfig-Editor.md). This tool also makes it easy to sync Identity and ID values directly from your Partner Center project.
...
At installation time, the operating system and Microsoft Store ensure that this package dependency is installed along with your app. For more information, including information about DirectX and Visual Studio C/C++ runtime framework package dependencies, see [Framework package dependencies](../packaging-framework-packages.md).


### Mods support  

Starting with the March 2022 Microsoft Game Development Kit (GDK), mods are supported by default. For more information, see [Mods](../packaging-mods.md).
