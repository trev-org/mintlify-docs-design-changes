...
The individual files produced by Split Package can be sideloaded by using [xbapp install (NDA topic)](../../../tools/tools-console/commandlinetools/xbapp.md) or [Xbox Manager (NDA topic)](../../../tools/tools-console/xbom/xbom.md). Assuming that the previous example layout was used, the following command installs disc 1:<br/>
