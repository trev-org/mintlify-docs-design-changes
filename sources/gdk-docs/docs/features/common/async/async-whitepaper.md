...
- Xbox services, Asynchronous programming design goals and improvements
- Xbox services, asynchronous
- Xbox services, asynchronous programming model
- Xbox services, threads
ms.author: chcoope
ms.topic: article
edited: 12/17/2020
ms.date: '08/01/2022'
 ...
 * [Normal errors are reported via HRESULT error codes](../../../gdk-dev/overviews/error-handling.md).  
...
include [Windows PC (NDA topic)](../../../gdk-dev/intro/introduction.md#shipping-a-game-on-Windows-PCs), [Xbox One family consoles, and Xbox Series consoles (NDA topic)](../../../gdk-dev/intro/introduction.md#Shipping-a-game-on-Xbox-consoles).
...
![Screenshot of the callback execution behavior of one thread](../../../../media/public-images/async_port_dispatch_singlethread.png)

**Figure 2. Shows the callback execution behavior of multiple threads**  

![Screenshot of the callback execution behavior of multiple threads](../../../../media/public-images/async_port_dispatch_multithread.png)
...
important for the Microsoft Game Development Kit (GDK) (NDA topic)](../../../gdk-dev/intro/introduction.md). The following
...
behavior. With this, the system managed its calls to Xbox services and
...
[Microsoft Game Development Kit (GDK) Async model](../../../gdk-dev/intro/introduction.md#microsoft-game-development-kit-gdk-async-model) switches the paradigm to a Win32-style C-style API model for async libraries. Microsoft Game Development Kit (GDK) code can be
...
For more information about error handling in the Microsoft Game Development Kit (GDK), see [Error handling in the Microsoft Game Development Kit](../../../gdk-dev/overviews/error-handling.md).
...
![Screenshot of the chart that measures asynchronous system overhead](../../../../media/public-images/async_system_overhead.png)
...
[Time-sensitive threads](../../../gdk-dev/console-dev/overviews/threads/time-sensitive-threads.md) are a new specification that the
...
with async tasks are time-sensitive safe. For more information about unsafe functions, see the [Unsafe functions for time-sensitive threads](../../../gdk-dev/console-dev/overviews/threads/time-sensitive-threads.md#unsafe-function-list) section of the Time-sensitive threads topic.
