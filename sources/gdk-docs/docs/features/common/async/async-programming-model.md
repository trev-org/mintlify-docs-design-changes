...
![Diagram of a task and a task queue.](../../../../media/public-images/async_task_taskqueue_diagram.png)
...
![Image that shows a port being dispatched on to the multiple threads.](../../../../media/public-images/async_port_dispatch_multithread.png)
