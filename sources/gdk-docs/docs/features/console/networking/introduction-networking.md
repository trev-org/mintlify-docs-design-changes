...
This article provides an introduction to the network stack in the Microsoft Game Development Kit (GDK). The networking stack and available APIs for Microsoft Game Development Kit (GDK) titles are similar to Win32 network APIs simplifying porting from existing Win32 titles and allows more unified network implementations.
...
| --- | :---: |
| All-in-one solution (network game data and in-game chat) | [PlayFab Party](game-mesh/playfab-party-intro-networking.md) |
...
| HTTP** | [xCurl](web-requests/intro-xcurl.md) or [WinHTTP](web-requests/intro-winhttp.md) |
...
| Socket security | OpenSSL Datagram Transport Layer Security (DTLS) or Bcrypt DTLS [(Secure Game Communication) (NDA article)](../../../gdk-dev/game-principles/security/communication-security/communication-security-impl/gc-secure-communication-impl.md) |
| Network connectivity | [XNetworkingGetConnectivityHint](initialization-connectivity-networking.md) |
| Port behavior | [Identical to Win32 Windows PC](game-mesh/winsock-intro-networking.md) |
| In-game chat | [PlayFab Party](game-mesh/playfab-party-intro-networking.md) or [Game Chat 2](../../../services/multiplayer/chat/game-chat2/game-chat-2-intro.md) |
...
Suspend and resume handling documentation:
 ...
 - [XCurl](web-requests/intro-xcurl.md#title-suspendresume)
 - [WinHTTP](web-requests/intro-winhttp.md)
 ...
 - [Network Initialization](initialization-connectivity-networking.md#suspend-and-resume)
 - [Game Chat 2](../../../services/multiplayer/chat/game-chat2/game-chat-2-intro.md#SuspendResume)

## Xbox One Software Development Kit migration

For details about titles that are migrating from the previous Xbox One Software Development Kit documentation, see [Xbox One Software Development Kit migration overview (NDA article)](xdk-migration/xdk-migration-overview-networking.md). This article includes guidance for titles that enable communication between the Xbox One Software Development Kit and the GDK title versions.
...
[Game Chat 2](../../../services/multiplayer/chat/game-chat2/game-chat-2-intro.md)
...
[Getting Started with Xbox Live APIs](../../../services/fundamentals/xbox-services-api/live-gs-xbl-apis.md)

[Preferred UDP multiplayer port](game-mesh/preferred-local-udp-multiplayer-port-networking.md)

[Secure Game Communication for Microsoft Game Development Kit Titles (NDA article)](../../../gdk-dev/game-principles/security/communication-security/communication-security-impl/gc-secure-communication-impl.md)
