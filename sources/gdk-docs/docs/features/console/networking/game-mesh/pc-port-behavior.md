...
```
When properties are added to the game's __MicrosoftGame.config__ file, they're applied to the generated __AppXManifest.xml__. To learn more about the generation process, see [MicrosoftGame.config overview](../../../common/game-config/MicrosoftGameConfig-Overview.md).
