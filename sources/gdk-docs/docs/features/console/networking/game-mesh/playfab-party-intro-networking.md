...
kindex:
- PlayFab Party
- Xbox services, PlayFab Party
- Xbox services, PlayFab
...
User communication for Xbox services titles must meet several requirements for user safety. Using PlayFab Party with the PlayFab Party Xbox services Plug-in ensures that your title meets all the Xbox services communication and security requirements.
...
PlayFab Party is free for the Microsoft Game Development Kit (GDK) by using Xbox services identities. For more information about pricing and billing, see [Xbox services Free Program FAQ](/gaming/playfab/multiplayer/networking/xbl-discount).
