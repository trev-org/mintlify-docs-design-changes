...
- Xbox services, Xbox Live Test Account tool (XblTestAccountGui.exe)
- Xbox services, Test Account tool
ms.topic: article
...
This command-line tool is part of the GDK and `XboxLiveTools.zip`; see [Development tools for Xbox services](live-tools.md).
...
Navigate to the **Gamertag** tab and enter a [modern gamertag](../../services/fundamentals/identity/user-profile/gamertags/live-modern-gamertags-overview.md). From your input, a [classic gamertag](../../services/fundamentals/identity/user-profile/gamertags/live-classic-gamertags-overview.md) will also be generated.
...
* [Creating test accounts](../../services/develop/test-accounts/live-setup-testaccounts.md)
