...
- Xbox services, trace analyzer
- Xbox services, service calls
- Xbox services, testing
ms.topic: article
...
The Trace Analyzer (**XblTraceAnalyzer.exe**) can be found as part of the GDK and `XboxLiveTools.zip`; see [Development tools for Xbox services](live-tools.md).
