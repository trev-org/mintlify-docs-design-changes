...
- Xbox services, Xbox Common Events Tool (XceTool.exe)
- Xbox services, Xbox common events
- Xbox services, events
- Xbox services, event manifest
ms.topic: article
...
> [!NOTE] 
> **This tool is deprecated and has been removed as of the October 2024 GDK**
...
| `-x <header.h>` | Generates a Common Schema 2 style header that wraps the XSAPI C++ write_in_game_event API with the event schema you have defined on XDP. See the [Events Overview](../../services/player-data/stats-leaderboards/event-based/events/live-game-events.md) article for more information. |
| `-xwinrt <header.h>` | Generates a Common Schema 2 style header that wraps the XSAPI WinRT WriteInGameEvent API with the event schema you have defined on XDP. See the [Events Overview](../../services/player-data/stats-leaderboards/event-based/events/live-game-events.md) article for more information. |
| `-xc <header.h>` | Generates a Common Schema 2 style header that wraps the XSAPI C XblEventsWriteInGameEvent API with the event schema you have defined on XDP. See the [Events Overview](../../services/player-data/stats-leaderboards/event-based/events/live-game-events.md) article for more information. |
