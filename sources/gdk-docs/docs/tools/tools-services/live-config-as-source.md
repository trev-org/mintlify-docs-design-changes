...
description: "Enables advanced users to integrate their tools with Xbox configuration services."
kindex:
- Config as Source tools (XblConfig.exe)
- XblConfig.exe
- Xbox services, Config as Source tools
- Xbox services, Config as Source tools (XblConfig.exe)
- Xbox services, XblConfig.exe
- Xbox services, Integrate tools with Xbox configuration services
ms.topic: article
