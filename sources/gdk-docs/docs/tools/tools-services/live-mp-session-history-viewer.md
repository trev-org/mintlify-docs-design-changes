...
- session history
- history viewer
- Xbox services, Multiplayer Session History Viewer (MultiplayerSessionHistoryViewer.exe)
- Xbox services, development tool
- Xbox services, session history
- Xbox services, history viewer
ms.topic: article
...
This standalone tool is part of the GDK and `XboxLiveTools.zip`; see [Development tools for Xbox services](live-tools.md).


![MPSD Session History Viewer](../../../media/public-images/live/test-release/tools/live-mp-session-history-viewer-images/live-session-history-viewer.png)
