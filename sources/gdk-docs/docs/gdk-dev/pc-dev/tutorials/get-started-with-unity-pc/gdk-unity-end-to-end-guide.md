...
description: "Describes how to integrate the GDK with your Unity PC game."
kindex:
- Integrating the GDK with your PC Unity game
- Unity, integrating with the GDK
- Xbox services, Unity GDK integration
- Xbox services, Unity GDK integration for PC
- 'Xbox services, Unity GDK integration for PC: get started'
- Xbox services, Integrating the GDK with your PC Unit game
- Xbox services, Unity
- Xbox services, Unity integration
...
* [Visual Studio 2019 (16.9) or later](../../../get-started/overviews/sdk-and-tools.md#install-visual-studio)
* [Windows SDK (22000 or later)](../../../get-started/overviews/sdk-and-tools.md#IDWSDK)
* [Windows 10 (1809 or later) or Windows 11](../../../get-started/overviews/set-up-dev-pc.md#software-requirements)
...
![Unity 6 version of the Unity Editor with both add-ons installed.](../../../../../media/public-images/unity-guide/unity-both-add-ons.png)  
...
1. Select the **Unity Registry** option from the right column.
1. In the **Search** box, enter **gdk**, and then wait for the list to refresh.
1. Select the **Microsoft GDK API** package, and then select **Install**.
1. After the installation is finished, select the **Microsoft GDK Tools** package and then select **Install**.
1. Close the Package Manager after both packages are installed.
...
![Overview of searching for the packages in the Unity registry in Unity 6.](../../../../../media/public-images/unity-guide/unity-searching-for-packages.png)
...
1. Select the **Start** button, and then select **Package Manager**.
1. Select **+**, and then select **Add package from tarball**.
1. Go to your .tgz extension downloaded package.
1. Select it, and then install it to your project.

**Figure 3.  Packages locally installed in a project in Unity 6.**

![Packages locally installed in a project in Unity 6.](../../../../../media/public-images/unity-guide/unity-packages-locally-installed.png)
...
![GDK Settings Asset being created in Unity 6.](../../../../../media/public-images/unity-guide/unity-creating-gdk-settings-asset.gif)
...
![GDK Settings being created for Xbox Series X\|S and Xbox One in Unity 6.](../../../../../media/public-images/unity-guide/unity-creating-gdk-settings-asset-xs-one.gif)
...
![Microsoft Game Config Asset being created in Unity 6.](../../../../../media/public-images/unity-guide/unity-creating-game-config-asset.gif)
...
![Associating your Microsoft Game Config in Unity 6.](../../../../../media/public-images/unity-guide/unity-associating-game-config.gif)
...
![Editing your Microsoft Game Config in Unity 6.](../../../../../media/public-images/unity-guide/unity-editing-game-config.gif)
...
![Starting the Store Association wizard within Unity 6.](../../../../../media/public-images/unity-guide/unity-store-association-wizard.png)
...
The Microsoft GDK API package for Unity provides a set of C# wrappers for native GDK APIs. Use these wrappers to directly access GDK APIs in your Unity project. For more information about accessing GDK APIs, see [Using C# wrappers for GDK APIs in your Unity project](features/gdk-unity-api-wrappers.md).  
...
![C# wrappers within the Microsoft GDK API package for Unity in the Packages window.](../../../../../media/public-images/unity-guide/unity-csharp-wrappers-packages-window.png)
...
![Samples tab within the Microsoft GDK API entry in the Unity registry after being downloaded.](../../../../../media/public-images/unity-guide/unity-registry-samples.png)
...
![Sample name in the list of builds under the GDK file type in the download portal.](../../../../../media/public-images/unity-guide/unity-sample-name-in-download-portal.png)
...
![Setting the GDK Settings values in Unity 6.](../../../../../media/public-images/unity-guide/unity-setting-gdk-settings.png)  
...
![Viewing each platform's build profiles in Unity 6.](../../../../../media/public-images/unity-guide/unity-viewing-platform-build-profiles.gif)
