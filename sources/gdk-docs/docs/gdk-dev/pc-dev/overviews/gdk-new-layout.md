---
author: chuckw
title: "GDK header and library directory structure"
description: "Describes the new directory layout for GDK headers and libraries."
kindex: GDK header and library directory structure
ms.author: chuckw
ms.topic: article
edited: 03/25/2026
ms.date: '03/25/2026'
...
For the new layout, the **Console_Libs** property lists the core required libraries.
