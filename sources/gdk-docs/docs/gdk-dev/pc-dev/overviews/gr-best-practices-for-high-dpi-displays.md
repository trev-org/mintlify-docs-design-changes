...
- [Visual Studio](../../../tools/tools-pc/visualstudio/gr-visualstudio-toc.md) has a DPI Awareness option in Configuration Properties, but this uses the older `<dpiAware>` tag, which doesn't work for MSIXVC-packaged titles.
