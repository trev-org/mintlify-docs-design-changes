...
To align with those changes, we rewrote a number of our game-centric services&mdash;including Xbox services, Connected Storage, and our packaging tools&mdash;to be identical on all our platforms. This will greatly increase code testability and reusability, especially for developers who want to bring their gaming content not only to Xbox but also to the Microsoft Store, where they can be part of initiatives like PC Game Pass.
