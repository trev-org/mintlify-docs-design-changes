...
- Xbox services, Gaming Runtime glossary
- Xbox services, glossary
...
* __Gaming Cloud Services:__ The cloud-hosted gaming-specific services like Xbox services, PlayFab, and Microsoft Store that are generally exposed as REST APIs.
...
* __Social Data Cache Service:__ The local service that runs on console and allows all UX apps access to the same Xbox services social data through a shared component. This service doesn't ship as part of the Gaming Runtime.