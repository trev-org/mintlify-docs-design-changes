...
* [Windows Software Development Kit (SDK)](sdk-and-tools.md#IDWSDK)
...
The Windows SDK exposes the following components of the gaming platform:
...
- New API for [gaming input](../../../features/common/input/gc-input-toc.md), which unifies the input model across gamepad, keyboard, mouse, touch, and other input devices.

- New API for process lifetime management (PLM).  

The Microsoft Game Development Kit (GDK) requires Windows SDK version 22000 or later. You can get the Windows SDK in two ways: install it by selecting the download link on the [Windows SDK](https://developer.microsoft.com/windows/downloads/windows-sdk/) download page or by selecting "Windows SDK for Windows 11 (10.0.22000.0)" in the optional components of the Visual Studio Installer.  

<a id="install-visual-studio"></a> 

## Visual Studio  

Visual Studio 2022 or Visual Studio 2026 is recommended for Gaming Runtime development. 
For more information on supported versions of Visual Studio, see [Visual Studio (NDA topic)](../../../tools/tools-console/visualstudio/visualstudio.md).   
> [!NOTE]
...
* Developers who use Xbox One Software Development Kit tools to develop games by using the Microsoft Game Development Kit with Xbox Extensions should be offered the same or equivalent tools for developing Microsoft Game Development Kit (GDK) games for Xbox console.
...
* Use familiar Microsoft Game Development Kit tools with Xbox Extensions to iterate, test, and debug remotely by using Xbox Series X|S dev kits, or Xbox One family dev kits.
...
After installing the required SDKs and tools in this step proceed to [Configuring your development network access for developing Microsoft Game Development Kit titles](../../console-dev/dev-kits/settings/configure-dev-network.md).
