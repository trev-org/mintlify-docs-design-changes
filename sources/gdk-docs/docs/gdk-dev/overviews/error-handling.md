...
The Microsoft Game Development Kit (GDK) introduces a new C style async model, described in [Asynchronous Programming Model](../../features/common/async/async-programming-model.md). In the async model, there are typically pairs of APIs that you call, for example, [XGameUiShowTextEntryAsync](../../reference/system/xgameui/functions/xgameuishowtextentryasync.md) and [XGameUiShowTextEntryResult](../../reference/system/xgameui/functions/xgameuishowtextentryresult.md).
