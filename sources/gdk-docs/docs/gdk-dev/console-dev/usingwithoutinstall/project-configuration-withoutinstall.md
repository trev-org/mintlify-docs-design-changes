...
> [!NOTE]
> For the [GDK New Layout](../overviews/gdkx-new-layout.md), the location of these files is in `C:\ExtractedGDK\251000\Microsoft GDK\251000\xbox\build` with shortened paths. The INCLUDE/LIB paths listed below also assume you are using the old layouts instead of the new simplified integration.
