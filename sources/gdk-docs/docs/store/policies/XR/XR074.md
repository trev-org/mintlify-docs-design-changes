...
ms.topic: article
kindex:
- Loss of connectivity to Xbox services
- Loss of connectivity to partner services
- partner services
- block xbox services
...
For information on networking using the GDK, read the [Networking section](../../../features/console/networking/gc-networking-toc.md).
