...
description: "XR-067 Maintaining Multiplayer Session State"
edited: 00/00/0000
ms.date: '08/01/2022'
...
For information on MPSD using the GDK, read the [Multiplayer Session Directory overview](../../../services/multiplayer/mpsd/live-mpsd-overview.md)
