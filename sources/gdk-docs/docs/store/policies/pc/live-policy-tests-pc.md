---
title: "Certification tested Xbox Requirements for PC and mobile games"
description: "Recommended XR test cases when adding Xbox network features to a PC, mobile or Creators Program game."
...
* For a summary of changes in this release, see [changes in this release](#changes) at the bottom of this page.
...
* View the [top failing test cases](live-TopFailingTestcases-pc.md) on PC.

## <a id='BaseRequirements'></a>Base Requirements
...
4. Using a new Xbox profile with no previous save data, repeat steps 1-3 while disconnected from the Xbox network.
...
* [Fiddler on PC](../../../features/console/networking/tools/fiddler-pc.md)
...
## <a id='UserProfiles'></a>User profiles
...
## <a id='OnlineSafety'></a>Online Safety and Privacy
...
## <a id='Achievements'></a>Achievements and Awards
...
## <a id='Multiplayer'></a>Multiplayer Sessions
...
## <a id='BVTs'></a>BVTs: Pre-certification testing of the build
