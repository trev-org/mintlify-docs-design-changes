---
title: "Top Failing Test Cases for PC"
author: LukeCraw
ms.author: lukecr
ms.topic: article
description: "Xbox Certification Top Failing Test cases for PC"
kindex: Top Failing Test Cases for PC
edited: 04/01/2025
ms.date: '08/01/2022'
...
* To see all Xbox Requirement (XRs) test cases for PC and mobile, go to [Xbox Requirement test cases for PC and mobile games](live-policy-tests-pc.md).

## Top Failing PC Test Cases

XR/Store Policy | Test Case | Distribution
--------|---------|----------
[10.4.2](/windows/apps/publish/store-policies#104-usability.md) | App Crash or Freeze | 34%
[XR-055: Achievements](live-policy-tests-pc.md) | 055-01 Achievements | 18%
[XR-064: Joinable Game Sessions and Online Play](../XR/XR064.md) | 064-02 Joining a Game Session from the Same Game | 13%
[XR-045: Xbox Network and Account Privileges](../XR/XR045.md) | 045-01 Respect User Privileges | 9%
[XR-052: User State and Title-Save Location, Roaming and Dependencies](../XR/XR052.md) | 052-05 Correct User Association | 4%
[XR-003: Title Integrity](../XR/XR003.md) | Title Integrity | 4%
[XR-064: Joinable Game Sessions and Online Play](../XR/XR064.md) | 064-02 Joining a Game Session from Outside the Game | 3%
[XR-015: Managing Player Communication](../XR/XR015.md) | 015-01 User Communication | 3%
[XR-022: Official Naming Standards](live-terminology-pc.md) | 022-01 Official Naming Standards | 3%
[XR-018: User-Generated Content](../XR/XR018.md) | 018-01 Reporting Inappropriate Content and UGC Text-String Verification | 3%
[XR-067: Maintaining Multiplayer Session State](../XR/XR067.md) | 067-01 Maintaining Session State |2%
[10.1](/windows/apps/publish/store-policies#101-distinct-function--value-accurate-representation.md) | Another Platform | 2%
[XR-052: User State and Title-Save Location, Roaming and Dependencies](../XR/XR052.md) | 052-05 Cloud Storage: Roaming |2%
...
The most common failures are when a title references competing platforms in text or images. Make sure all text and images comply with the [terminology list](../Console/console-TopFailingTestcases.md) and do not reference competing platforms (i.e. images of a competitor's controller or button call outs).
...
Titles that use the [`StringService`](/dotnet/api/microsoft.xbox.services.system.stringservice) API meet the proactive detection requirement (for text scenarios) automatically. Titles should default to leveraging the StringService API for names and other short static text strings. If titles have other text scenarios that allow lengthier text input, or if there are technical or other limiting circumstances, titles can choose to implement their own variant of text filtering by restricting a set of terms from being displayed to another player on Xbox services. See the [list of core words](/gaming/xbox-nda-docs/_content/gc/policies/console/certification-forbidden-terms) that must be leveraged as a minimum baseline for blocking or obfuscation from non-local players on Xbox services.
