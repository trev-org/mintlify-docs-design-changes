---
title: "Requirements for Beta and Xbox Game Preview Titles"
author: M-Stahl
kindex:
- Requirements for Beta and Xbox Game Preview Titles
- Beta and Xbox Game Preview Titles, Requirements for
- preview and beta Xbox game title requirements
ms.author: lukecr
ms.topic: article
description: "Because players expect Game Previews and beta releases to be unfinished products, Xbox offers the option to test these products against less-stringent requirements and certification criteria."
edited: 12/01/2023
ms.date: '08/01/2022'
permissioned-type: public
---

# Requirements for Open Betas and Game Previews
