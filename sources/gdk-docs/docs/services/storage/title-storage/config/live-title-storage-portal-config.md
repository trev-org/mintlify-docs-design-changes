...
This topic describes the Title Storage service, and how by using Xbox services, you can save data that's associated with your game to the cloud. Use the **Title Storage** configuration page to determine which types of cloud storage services that your game allows and upload files to Global Storage.
...
![Screenshot that shows Title Storage settings](../../../../../media/public-images/live/features/cloud-storage/title-storage-settings.JPG)
...
![Screenshot that shows Global storage file management](../../../../../media/public-images/live/features/cloud-storage/global-storage-file-management.JPG)
...
![Screenshot that shows the New folder dialog box](../../../../../media/public-images/live/features/cloud-storage/add-folder-global-storage-filled.JPG)
...
![Screenshot that shows the Global storage file management dialog box](../../../../../media/public-images/live/features/cloud-storage/global-storage-management.gif)
