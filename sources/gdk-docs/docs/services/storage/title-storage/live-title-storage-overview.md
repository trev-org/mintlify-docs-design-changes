...
description: "Describes what Xbox services Title Storage is, what its features are, and demonstrates how to configure them."
kindex:
- Title Storage overview
- Xbox services, Title Storage overview
- Xbox services, Title Storage configuration
author: joannaleecy
ms.topic: article
...
This topic describes what Xbox services Title Storage is, what its features are, and demonstrates how to configure them.
The Xbox services Title Storage service provides cloud storage for large amounts of per-player  or per-game data. You can use it for storing player statistics and assets. Games running on all Xbox platforms can use Title Storage.

<a name="ID4EW"></a>

## Features of Xbox services Title Storage

Xbox services Title Storage includes the following high-level features.
