...
description: "Demonstrates how to get Xbox Title Storage blob metadata."
kindex:
- Getting Title Storage blob metadata
- Xbox services, Getting Title Storage blob metadata
- Xbox services, Title Storage
- Xbox services, Title Storage blob metadata
- Xbox services, Title Storage metadata
ms.topic: article
