...
description: "Describes Xbox services Cloud Storage, which includes Connected Storage to store game state, and Title Storage to store player statistics and assets."
kindex:
- Connected Storage vs. Title Storage
- Title Storage
- Xbox services, Connected Storage vs. Title Storage
- Xbox services, Connected Storage
- Xbox services, Title Storage
- Xbox services, store game state
- Xbox services, store player statistics
- Xbox services, store assets
author: joannaleecy
ms.topic: article
