---
title: "Summary page for Xbox services configuration"
description: "Using the Summary tab in Partner Center."
kindex:
- Summary page for Xbox services configuration
- Xbox services, Summary page for Xbox services configuration
- Xbox services, Summary page
- Xbox services, Xbox services configuration
- Xbox services, Partner Center Summary tab
- Xbox services, Partner Center Summary page
- Xbox services, Summary tab
author: joannaleecy
ms.topic: article
ms.date: 10/19/2018
...
To configure Xbox services for your title, you can use [Partner Center](https://developer.microsoft.com/dashboard).
With Partner Center, you can manage the service configuration for each of your title's sandboxes.

To configure the Xbox services aspects of your title, select **Xbox services** > **Gameplay settings**.
...
![Switching sandbox tabs](../../../../media/public-images/live/test-release/portal-config/live-portal-summary-images/sandbox-tabs1.gif)
...
![Expanding to a new sandbox tab](../../../../media/public-images/live/test-release/portal-config/live-portal-summary-images/sandbox-tabs2.gif)

See [Xbox services Sandboxes overview](../sandboxes/live-setup-sandbox.md).
...
![The command bar](../../../../media/public-images/live/test-release/portal-config/live-portal-summary-images/command-bar.png)
...
![Summary table](../../../../media/public-images/live/test-release/portal-config/live-portal-summary-images/summary-table.png)
...
![History pane](../../../../media/public-images/live/test-release/portal-config/live-portal-summary-images/history.png)


## Best practices

* Publish your changes to your sandbox after you have made a few edits to ensure they are live on your [test accounts](../../develop/test-accounts/live-setup-testaccounts.md) and devices.
