---
title: "Configuring Xbox services setup in Partner Center"
description: "Configuring Xbox services setup in Partner Center."
kindex:
- Configuring Xbox services setup in Partner Center
- Xbox services setup
- Partner Center
- Xbox Live
- Xbox services, Configuring Xbox services setup in Partner Center
- Xbox services, Xbox services setup
- Xbox services, Partner Center
- Xbox services, Partner Center configuration
author: joannaleecy
ms.topic: article
ms.assetid: ''
ms.date: 10/30/2017
...
You can use [Partner Center](https://developer.microsoft.com/dashboard) to configure the initial set of Xbox services properties that are associated with your game.

Add configuration by doing the following:

1. Navigate to the **Xbox services** > **Xbox Settings** section for your title.
...
![Image of the Add localized title dialog in Partner Center](../../../../media/public-images/live/test-release/portal-config/xbox-live-setup-images/xbox-live-setup-1.png)


## Default locale

This option sets the default language used to configure all your strings in the Xbox services configuration.
...
Your Xbox services configuration must be provided in the same version as that of the default locale.
By default, the locale is set to English (en-US).
...
![Image of the select drop-down to choose your default locale in Partner Center](../../../../media/public-images/live/test-release/portal-config/xbox-live-setup-images/xbox-live-setup-2.png)


## Device families

This configuration allows you to choose the type of devices on which your title can access Xbox services.
...
![Image of the selection check boxes to select the device families in Partner Center](../../../../media/public-images/live/test-release/portal-config/xbox-live-setup-images/xbox-live-setup-4.png)
...
The date that you select determines when your Xbox services configuration goes live to the public.
...
XBL Embargo only impacts Xbox services-related features, and doesn't impact pricing and availability.
For more information on pricing, see [Pricing and Offers](/partner-center/pricing-and-offers).


**Xbox services features that are embargoed:**

The following table indicates whether the Xbox services feature is embargoed.
...
![Embargo settings in Partner Center](../../../../media/public-images/live/test-release/portal-config/xbox-live-setup-images/embargo3resize.png)

**To set the embargo date:**

1. In Partner Center, select your title, then select **Xbox services** > **Xbox Settings**. The **Xbox Live configuration** page appears.

2. In the **Embargo date** section, select the **Set embargo date** check box.  A date box appears: ![Setting the embargo date in Partner Center](../../../../media/public-images/live/test-release/portal-config/xbox-live-setup-images/embargo1.png)

3. Click the date box to expand the date: ![Setting the embargo date in Partner Center](../../../../media/public-images/live/test-release/portal-config/xbox-live-setup-images/embargo2.png)
...
Multiple points of presence allows the same user to sign in to the Xbox network (also known as Xbox Live) from multiple devices at the same time.
Xbox services features such as, achievements and multiplayer will have limited access.
