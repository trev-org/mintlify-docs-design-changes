...
kindex:
- Best practices, Live RTA service
- RTA
- Xbox services
ms.topic: article
...
[Xbox Services API (XSAPI)](../../xbox-services-api/live-introduction-to-xbox-live-apis.md) handles the authentication token refresh for the title by proactively reconnecting to RTA and resubmitting subscriptions after 90 minutes. 
...
[Getting started with XSAPI](../../xbox-services-api/live-gs-xbl-apis.md)
