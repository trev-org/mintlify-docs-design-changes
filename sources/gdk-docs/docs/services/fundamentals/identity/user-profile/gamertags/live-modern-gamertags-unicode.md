...
description: "Describes modern gamertags and the UTF-8 character ranges that are supported for them by Xbox services."
kindex:
- gamertags
- Xbox services, gamertags
- Xbox services, UTF-8
- Xbox services, UTF-8 character ranges for modern gamertags
- Xbox services, UTF-8 gamertags
author: joannaleecy
ms.author: rlehew
ms.topic: article
...
![Table that shows Latin allowed vs. reserved characters](../../../../../../media/public-images/live/identity/modern-gamertags/visual-guide-latin-chars.png)
