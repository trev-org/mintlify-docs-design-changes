...
description: "Describes how the game sends events to the Xbox services stats processor service. The processor uses the stat rules that you've defined in your Xbox services configuration in Partner Center to process these events and update stats on the service. The game can then retrieve the updated stats from the Xbox services stats service."
kindex:
- Event-based Stats overview
- stats, Xbox Live
- Xbox services, Event-based stats
- Xbox services, Event-based stats overview
- Xbox services, Send events to the stats processor
- Xbox services, Partner Center events
- Xbox services, Stats configuration
author: joannaleecy
ms.topic: article
...
Configure stat rules to control how Xbox services should produce stat instances based on events that are sent by the game (figure 1).
...
![Image of a figure that shown events, stat rules, and user stats. The first block shows Event and Enemy defeated. The second block shows Stat Rule and Kills. The third block shows Stat Instance and Kills.](../../../../../media/public-images/live/stats/events-and-user-stats2.png)
...
![Image of a figure that show events and stat templates. The first block shows Event and EnemyDefeated with WeaponID, DifficultyLevel. The second block shows Stat Rule with Kills.WeaponID. The third block shows Stat Instance with Kills.WeaponID.Pistol and KillsWeaponID.Rifle.](../../../../../media/public-images/live/stats/stat-templates.png)
...
Stat rules are triggered when an event of a particular name is received by Xbox services.
...
![Image of a figure that shows events, stat rules, and user stats with the locations of processing.](../../../../../media/public-images/live/stats/stats2013diagram.jpg)
