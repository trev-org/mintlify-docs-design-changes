...
Sending game events to your Xbox services configuration to update User Stats, Featured Stats, Achievements, and Leaderboards.  
  
[Portal config](config/live-events-config-nav.md)  
Describes how to configure events for Xbox services in Partner Center.  
