...
kindex:
- Xbox services events
- events, Xbox Live
- Xbox services, Portal configuration of events
- Xbox services, Adding and changing events in Partner Center
- Xbox services, Partner Center events configuration
- Xbox services, Events
author: joannaleecy
ms.topic: article
...
This topic describes the procedures for adding and changing events in the Partner Center service configuration for a title. If a title is using event-based Stats, events are the key data sent by the title to Xbox services to update stats and leaderboards and to unlock achievements.

For an introduction to Xbox services configuration, see [Xbox services overview](../../../../../fundamentals/live-xbl-overview.md).
...
1. Select your title, and then select **Xbox services** > **Gameplay settings** in the left navigation pane.

1. Select the link **Player stats** > **Stat rules**.

1. On the **Events and stat rules** page, shown as follows, configure the events and stat rules according to the events.

   

   ![Screenshot of the Events and stat rules page in Partner Center.](../../../../../../../media/public-images/live/events/events-and-stat-rules-1.png)
...
1. Select **New event**. The **Add new event** dialog appears, shown as follows.
   ...
   ![Screenshot of the Add new event dialog in Partner Center.](../../../../../../../media/public-images/live/stats/pctr-add-new-event-dbox.png)
...
1. Specify the values for the following fields.
   ...
   * **Base event**: From the dropdown list, shown as follows, select the base event that you want to build your new event on. The selected base event controls the default fields that your new event is prepopulated with. You can add any other fields, but you can't remove the default fields.
   ...
   ![Screenshot of the Base event list in Partner Center.](../../../../../../../media/public-images/live/stats/pctr-base-event-list.png)
   ...
   *  **Description**: Enter a brief description of the event. This text is optional and hidden from the player. The following screenshot shows the **Add new event** dialog with information added to its fields.
   ...
   ![Screenshot of the Add new event dialog with information added to its fields in Partner Center.](../../../../../../../media/public-images/live/stats/pctr-add-new-event-dbox-filled-in.png)
   ...
   *  **Event fields**:  
   ...
   ![Screenshot of adding an event field in Partner Center](../../../../../../../media/public-images/live/stats/pctr-add-event-field.png)

1. Select **Save** to create the event and close the dialog, shown as follows.

   ![Screenshot of the Add new event dialog with a new Basic base event in Partner Center.](../../../../../../../media/public-images/live/events/add-event-dialog.png)

Your new event is now listed on the **Events and stat rules** page, shown as follows.

![Screenshot of the Events and stat rules page with the RecruitUnit event added in Partner Center.](../../../../../../../media/public-images/live/events/events-and-stat-rules-2.png)
...
![Image of a diagram that shows how deleting an event deletes chained dependencies.](../../../../../../../media/public-images/live/events/event_delete_dependency.png)  
