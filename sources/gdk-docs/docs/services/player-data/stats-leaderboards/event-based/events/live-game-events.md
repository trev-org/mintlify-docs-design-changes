...
description: "Sending game events to your Xbox services configuration to update User Stats, Featured Stats, Achievements, and Leaderboards."
kindex:
- Events overview
- Xbox Live, game events
- game events, Xbox Live
- Xbox services, game events
- game events, Xbox services
author: joannaleecy
ms.topic: article
...
![Fiddler Undecoded Event](../../../../../../media/public-images/live/stats/evented/game-events/fiddler1.png)
...
![Fiddler Decoded Event](../../../../../../media/public-images/live/stats/evented/game-events/fiddler2.png)
