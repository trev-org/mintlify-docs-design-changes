...
For an introduction to service configuration, see [Portal configuration overview](../../../../fundamentals/portal-config/live-portal-config-overview.md).

For more information about RTA, see [Real-Time Activity (RTA) service](../../../../fundamentals/rta/live-rta-nav.md).
...
For more information, see [Programming the RTA service](../../../../fundamentals/rta/how-to/live-programming-rta.md).
