...
- Xbox services, Event-based Leaderboards overview
- Xbox services, Leaderboards
- Xbox services, Event-based Leaderboards
- Xbox services, Xbox Live Leaderboards
- Xbox services, selected stats
author: joannaleecy
ms.topic: article
...
Leaderboards are a fun way to engage players and drive competition among them. Xbox services provides functionality that's suited for your hardcore players (*global* ranking against the whole Xbox population) and for your casual players (*social* ranking against a player's friends).
...
* A global leaderboard ranks the whole Xbox user base and must be configured.
...
* A value to be ranked against (in Xbox services, this is always a player [stat instance](live-stats-eb-overview.md#defining-stat-instances)).
...
![Screenshot of a Leaderboard details UI with a leaderboard name of FastestLap. The sort order shows that lower values are better.](../../../../../media/public-images/live/leaderboards/leaderboard-details.png)
...
* Leaderboards for featured stats are sometimes displayed in other Xbox experiences, such as a player's achievement view in their profile.
