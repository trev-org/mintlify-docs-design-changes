...
- Xbox services, Portal configuration of event-based Featured Stats
- Xbox services, event-based Featured Stats
author: joannaleecy
ms.topic: article
...
> [!NOTE]
> This article describes features that are available only with proper permissions. For details, talk to your account manager or another contact at Microsoft.

This article describes how to add and change featured stats in the Partner Center service configuration for a title.
For an introduction to the Xbox service configuration, see [Portal configuration overview](../../../../fundamentals/portal-config/live-portal-config-overview.md).
...
2. Select your title, and then select **Xbox services** > **Gameplay settings**.

3. Select the link to **Player stats** > **Featured stats**.

4. Designate new featured stats or re-order existing featured stats.

Featured-stat configurations support Rich Presence variables.
...
3. In the dropdown list under **Select a player stat to rank players with**, select the player stat instance to be featured. 
