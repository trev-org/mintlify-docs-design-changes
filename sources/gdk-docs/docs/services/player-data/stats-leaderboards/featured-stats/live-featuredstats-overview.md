...
- Xbox services
- Xbox services, Hero Stats
- Xbox services, Featured Stats Overview
...
Think of featured stats as an opportunity for each Xbox services title to prominently display interesting data about the user's activity directly into the system UX.
...
![Featured Stats](../../../../../media/public-images/live/featured-stats/featured_stats_screenshot.png)
