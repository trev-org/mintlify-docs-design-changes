...
For an introduction to Xbox services configuration, see [Xbox services configuration IDs for Managed Partners](../../../../fundamentals/portal-config/live-service-config-ids-mp.md).
...
This topic covers the following:  
   ...
   *  [How challenges work in Xbox services](#ID4EYB)  
