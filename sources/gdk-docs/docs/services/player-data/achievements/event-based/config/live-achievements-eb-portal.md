...
- Xbox services, Portal configuration
- Xbox services, Portal configuration of event-based Achievements
- Xbox services, event-based Achievements
- Xbox services, add or change achievements by using Partner Center
author: joannaleecy
ms.topic: article
...
* [How achievements work in Xbox services for Xbox One or later](#ID4EYB)  
