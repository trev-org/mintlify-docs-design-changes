...
- Achievements
- Xbox Live
- Xbox services, Scenarios for creating event-based achievements
- Xbox services, event-based achievement scenarios
- Xbox services, event-based achievements
- Xbox services, creating event-based achievements
author: joannaleecy
ms.topic: article
...
Use this pattern to define an achievement that requires a user to do a complex activity that can't be tracked easily via Xbox services Stats or that isn't supported by other Xbox services achievements configuration options.
