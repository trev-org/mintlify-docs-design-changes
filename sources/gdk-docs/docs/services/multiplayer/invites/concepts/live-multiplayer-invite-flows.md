...
- Xbox services, Flows for multiplayer game invites
author: joannaleecy
ms.topic: article
...
The <b>highlighted text</b> shows the adjustments that have been made from the prior UX flows.  
...
<table>
  ...
  <tr>
    ...
    <td>
      <p>A toast notification appears that indicates a multiplayer game invitation has arrived from Felix, and <b>it displays the game name and icon</b>.</p>
      <p>In the <b>Notification center</b>, <b>Hannah can select "Launch and accept invite"</b>, "Accept invite", or <b>"Decline invite"</b>.</p>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <b>Case 1: Hannah selects "Launch and accept invite"</b>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      ...
      <p><b>A toast notification appears that indicates that a game invite was sent to Hannah.</b></p>
    </td>
    <td>
  ...
  <tr>
    <td>4.</td>
    <td>
      <b>A toast notification appears that indicates that a game invite was sent to Hannah.</b>
    </td>
    <td>
      &nbsp;
    </td>
    ...
    <td>
      ...
      <p>In the <b>Notification center</b>, Hannah can select one of the following options.
        <ul>
          ...
          <li><b>"Leave party" to remove oneself from the party.</b></li>
        </ul>
      </p>
    </td>
  </tr>
...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <p><b>A toast notification appears that indicates that a game invite has been sent to Hannah.</b></p>
    </td>
    <td>
      &nbsp;
    </td>
...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <p><b>A toast notification appears that indicates that a game invite has been sent.</b></p>
    </td>
    <td>
