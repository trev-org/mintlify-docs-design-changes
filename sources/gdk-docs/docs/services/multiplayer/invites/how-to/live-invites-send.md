...
- Sending invites
- invites
- Xbox services, Sending invites
- Xbox services, Invites
- Xbox services, Sending invites example
...
[XGameActivation (API Reference)](../../../../reference/system/xgameactivation/xgameactivation_members.md)  
