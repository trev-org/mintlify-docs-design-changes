...
![Image of a matchmaking QoS flowchart that illustrates how to implement the initialization of the target session and QoS operations](../../../../../media/public-images/live/multiplayer/Multiplayer_2015_Matchmaking_QoS.png)
