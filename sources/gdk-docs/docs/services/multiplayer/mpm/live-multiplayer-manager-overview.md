...
- Xbox services, Multiplayer Manager overview
- Xbox services, Multiplayer Manager API
- Xbox services, Matchmaking API
- Xbox services, Game invites API
author: joannaleecy
ms.topic: article
...
Xbox services provides extensive support for adding multiplayer functionality to your titles so that your game can connect Xbox members across the world.
...
* [XblMultiplayerManagerDoWork](../../../reference/live/xsapi-c/multiplayer_manager_c/functions/xblmultiplayermanagerdowork.md): Ensures proper game state updates are maintained between the title and the Xbox services Multiplayer service.
...
* Throttling of MPSD calls to adhere to [Fine-Grained Rate Limiting](../../develop/best-practices/live-fine-grained-rate-limiting.md)
