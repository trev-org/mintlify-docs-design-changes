...
![An image of a SmartMatch matchmaking flowchart that shows shutting down a multiplayer session after a multiplayer game is complete, and the session is no longer needed.](../../../../../../media/public-images/live/multiplayer/mpm-shut-down.png)
