...
![An image of a SmartMatch matchmaking flowchart that shows the flow of inviting another player so that they can join the game. TCUI represents commonly used UI elements, such as a friend picker for invites.](../../../../../../media/public-images/live/multiplayer/mpm-send-invites.png)  
