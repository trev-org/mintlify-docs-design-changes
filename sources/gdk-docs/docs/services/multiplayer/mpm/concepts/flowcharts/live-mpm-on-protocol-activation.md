...
![An image of a SmartMatch matchmaking flowchart that shows the flow of responding to a game invite or joining a game via the user's profile card.](../../../../../../media/public-images/live/multiplayer/mpm-on-activation.png)  
