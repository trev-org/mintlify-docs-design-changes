...
![An image of a multiplayer flowchart that applies to the client that's starting the multiplayer game.](../../../../../../media/public-images/live/multiplayer/mpm-play-with-friends-inviter.png)

## Accept an invite to a game

The following flowchart applies to the client that receives and accepts an invite to a game.

![An image of a multiplayer flowchart that applies to the client that receives and accepts an invite to a game.](../../../../../../media/public-images/live/multiplayer/mpm-play-with-friends-invitee.png)  
