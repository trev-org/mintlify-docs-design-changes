...
- Xbox services, Multiplayer Manager API
- Xbox services, Multiplayer Manager API overview
author: joannaleecy
ms.topic: article
...
For examples of how to use these APIs in an application, see the [NetRumble sample (NDA topic)](../../../../gdk-dev/development-downloads/gdk-samples-list.md).
...
- [Multiplayer Manager API overview](#multiplayer-manager-api-overview)
  - [Namespace](#namespace)
  - [Multiplayer Manager class <a name="multiplayer-manager-class"></a>](#multiplayer-manager-class-)
  - [Multiplayer Event class <a name="multiplayer-event-class"></a>](#multiplayer-event-class-)
  - [Multiplayer Member class <a name="multiplayer-member-class"></a>](#multiplayer-member-class-)
  - [Multiplayer Lobby Session class <a name="multiplayer-lobby-session-class"></a>](#multiplayer-lobby-session-class-)
  - [Multiplayer Game Session class <a name="multiplayer-game-session-class"></a>](#multiplayer-game-session-class-)
...
| [XblMultiplayerManagerFindMatch](../../../../reference/live/xsapi-c/multiplayer_manager_c/functions/xblmultiplayermanagerfindmatch.md) | `find_match()` | Use Xbox services matchmaking to find and join a game. |
...
| [XblMultiplayerManagerLobbySessionInviteFriends](../../../../reference/live/xsapi-c/multiplayer_manager_c/functions/xblmultiplayermanagerlobbysessioninvitefriends.md) | `invite_friends()` | Opens a standard Xbox UI that allows the player to select friends from their friends list, and then invites those players to the game. |
| [XblMultiplayerManagerLobbySessionInviteUsers](../../../../reference/live/xsapi-c/multiplayer_manager_c/functions/xblmultiplayermanagerlobbysessioninviteusers.md) | `invite_users()` | Invites the specified Xbox players to the game. |
...
The game session represents the group of Xbox services members that are participating in an instance of actual game play.
...
If you want to use Xbox services matchmaking, call [XblMultiplayerManagerFindMatch](../../../../reference/live/xsapi-c/multiplayer_manager_c/functions/xblmultiplayermanagerfindmatch.md).
