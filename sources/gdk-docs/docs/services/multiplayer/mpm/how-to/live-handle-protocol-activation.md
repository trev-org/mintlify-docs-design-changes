...
After the game starts, get the invite handle by using [XGameActivationRegisterForEvent](../../../../reference/system/xgameactivation/functions/xgameactivationregisterforevent.md). With the invite handle, call [XblMultiplayerManagerJoinLobby](../../../../reference/live/xsapi-c/multiplayer_manager_c/functions/xblmultiplayermanagerjoinlobby.md).
