...
- Xbox services, Enable playing a multiplayer game with friends by using Multiplayer Manager
- Xbox services, Multiplayer
- Xbox services, Multiplayer Manager
- Xbox services, Enable multiplayer
author: joannaleecy
ms.topic: article
...
Games can also use the [XblMultiplayerManagerLobbySessionInviteUsers](../../../../reference/live/xsapi-c/multiplayer_manager_c/functions/xblmultiplayermanagerlobbysessioninviteusers.md) method to send invites to a set of people who are defined by their Xbox services User IDs.
...
On Microsoft Game Development Kit (GDK)-based games, after the game starts, listen to invite events by calling [XGameActivationRegisterForEvent](../../../../reference/system/xgameactivation/functions/xgameactivationregisterforevent.md).
...
For more information, see [XblMultiplayerManagerJoinGameFromLobby](../../../../reference/live/xsapi-c/multiplayer_manager_c/functions/xblmultiplayermanagerjoingamefromlobby.md).
