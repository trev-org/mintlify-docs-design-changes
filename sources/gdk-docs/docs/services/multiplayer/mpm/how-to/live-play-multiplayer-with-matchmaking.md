...
- SmartMatch
- Xbox services, Enable finding a multiplayer game by using SmartMatch using Multiplayer Manager
...
Games can also use the [XblMultiplayerManagerLobbySessionInviteUsers](../../../../reference/live/xsapi-c/multiplayer_manager_c/functions/xblmultiplayermanagerlobbysessioninviteusers.md) method to send invites to a set of players who are defined by their Xbox services User IDs.
