...
Game Chat 2 requires that your project has been set up for the GDK. For details about how to get set up, see [Get started with the Microsoft Game Development Kit](../../../../gdk-dev/get-started/get-started-home.md).
...
This is done by using the [XUserAddAsync API](../../../../reference/system/xuser/functions/xuseraddasync.md). For more information about using this API, see [User identity and XUser](../../../../features/common/user/player-identity-xuser.md).
...
<a id="adding_users_to_game_chat_2"></a>
