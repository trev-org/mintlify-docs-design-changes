...
> [!NOTE] 
> It is recommended to use PlayFab Party over GameChat2 API.
> For more information about integrating PlayFab Party for voice chat, see [Understanding how PlayFab Party chat works](/gaming/playfab/features/multiplayer/networking/concepts-chat).

## See also

[PlayFab Party](../../../features/console/networking/game-mesh/playfab-party-intro-networking.md)
