...
This topic describes an example scenario that demonstrates cross-network functionality and flow in a traditional multiplayer online battle arena (MOBA) game. It presents one possible design and implementation path. This topic is in support of [XR-007: Cross-Network Play, Data Usage, and Companion App Interactions](https://developer.microsoft.com/en-us/games/xbox/docs/gdk/xr007).
...
6. Team lobby.
    ...
    ![Screenshot that shows the cross-network roster UI](../../../../media/public-images/live/policies/console/xr/xr007-crossnetworkroster.png)
...
![Screenshot that shows player communication blocking](../../../../media/public-images/live/policies/console/xr/xr007-playercommblocking.png)
...
![Screenshot that shows a merged leaderboard](../../../../media/public-images/live/policies/console/xr/xr007-leaderboard.png)
