...
- SmartMatch hopper
- Xbox services, Configuring the Multiplayer service
- Xbox services, service configuration
- Xbox services, session template
- Xbox services, custom invite string
- Xbox services, SmartMatch hopper
author: joannaleecy
ms.topic: article
...
| Contract version | This value is automatically populated by the system and denotes the current system version of the JSON contract. Don't edit this value. |
