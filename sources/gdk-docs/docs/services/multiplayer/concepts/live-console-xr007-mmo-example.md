...
This topic describes cross-network functionality and flow in a massive multiplayer online (MMO) game. This topic is in support of [XR-007: Cross-Network Play, Data Usage, and Companion App Interactions](https://developer.microsoft.com/en-us/games/xbox/docs/gdk/xr007).
...
5. Instanced gameplay.
    ...
    ![Screenshot that shows an example of an MMO group](../../../../media/public-images/live/policies/console/xr/xr007-MMOGroup.png)
