...
- invites
- recent players
- Xbox services, Multiplayer Activity (MPA) feature overview
- Xbox services, MPA
- Xbox services, Multiplayer Activity
ms.topic: article
...
This topic describes how the Multiplayer Activity (MPA) feature simplifies Xbox services integration for
...
1. When player A starts or joins a multiplayer experience, the title should [set an
   ...
   this.
   *  Other players in the title and Xbox services can [retrieve this
     ...
     progress.
2. Player A can send [Invites](how-to/live-mpa-client-how-to.md#invites)
...
For more information, see [Xbox services RESTful reference](../../../reference/live/rest/atoc-xboxlivews-reference.md).
