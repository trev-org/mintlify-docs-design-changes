...
For information about an invite's contents, see [Send a request for another player to join a multiplayer experience.](../concepts/live-mpa-invites.md#send-a-request-for-another-player-to-join-a-multiplayer-experience).
