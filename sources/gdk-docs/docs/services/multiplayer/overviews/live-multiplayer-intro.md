...
description: "Describes multiplayer features in Xbox services that include Multiplayer Session Directory (MPSD), matchmaking, networking, voice chat, and text chat."
kindex:
...
- Xbox services, networking
- Xbox services, voice chat
- Xbox services, text chat
- Xbox services, Multiplayer Manager
- Xbox services, MPM
author: joannaleecy
ms.topic: article
...
* [Multiplayer overview (NDA topic)](multiplayer-intro.md)  
* [Xbox and PC multiplayer design guidance (NDA topic)](multiplayer-design-guidance-xbox-pc-gdk.md)  
* [Cross-platform multiplayer design guidance (NDA topic)](multiplayer-design-guidance-cross-platform.md)  

If your titles need server hosting, see [Multiplayer Servers](/gaming/playfab/features/multiplayer/servers/).  

By building a great multiplayer experience, your title can use the large social network of Xbox services gamers to help increase the gamer base for your game and promote a sustained community of dedicated fans&mdash;playing together.  
...
- [Xbox services multiplayer overview](#xbox-services-multiplayer-overview)
  - [Xbox services multiplayer features](#xbox-services-multiplayer-features)
    - [Multiplayer session process lifetime management](#multiplayer-session-process-lifetime-management)
      - [Multiplayer Session Directory (MPSD)](#multiplayer-session-directory-mpsd)
      - [Multiplayer Manager (MPM)](#multiplayer-manager-mpm)
    - [Simple and advanced matchmaking](#simple-and-advanced-matchmaking)
    - [Xbox services social experiences for titles with custom session and matchmaking components](#xbox-services-social-experiences-for-titles-with-custom-session-and-matchmaking-components)
...
There are several types of services available. For more information about the differences between these services, see [Multiplayer overview (NDA topic)](multiplayer-intro.md).  
...
You can also integrate the Xbox Looking for Group system in your title so that gamers can find other Xbox services gamers who share their interests and goals. For more details, see [Matchmaking overview](../matchmaking/live-matchmaking-overview.md).  
...
Game Chat 2 facilitates secure in-game communication by using Xbox services social graph, media services, and specialized encoding hardware on Xbox One (or later) devices. For more details, see [Intro to Game Chat 2](../chat/game-chat2/game-chat-2-intro.md).  
