...
description: "Describes the privilege codes for Social Manager."
...
The following table provides the privilege codes and their descriptions for Social Manager.
...
| 214   | premium_content   | Can purchase, download, and launch premium content that's available with the Xbox Live Gold subscription.     |
...
| 255   | add_friend    | Can follow other Xbox network (also known as Xbox Live) users and add Xbox network friends.   |
