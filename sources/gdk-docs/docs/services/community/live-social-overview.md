...
description: "Xbox services Social features provide a gaming-oriented social network that includes a user's profile, gamerscore, achievements, and activity feed."
kindex:
- Overview of Social features
- Xbox services, Overview of Social features
- Xbox services, Social Features overview
- Xbox services, Social features
- Xbox services, Gamerscore
- Xbox services, Achievements
- Xbox services, Activity feed
author: joannaleecy
ms.topic: article
...
Xbox services offers the best gaming social network with over 50 million active gamers and growing.

We have created a set of tools to bring gamers together and get their eyes on new and exciting games.
Integrating the Xbox services Social features in your title provides a huge return on investment whether you are building a single player casual game, a companion app, or a massive multiplayer game.


## Concepts in this article

- [Overview of Social features](#overview-of-social-features)
  - [Concepts in this article](#concepts-in-this-article)
  - [Bringing gamers together](#bringing-gamers-together)
    - [Profile](#profile)
    - [Gamerscore and Achievements](#gamerscore-and-achievements)
    - [The people system - Your social network on Xbox services](#the-people-system---your-social-network-on-xbox-services)
  - [Getting eyes on games](#getting-eyes-on-games)
    - [Clips and screenshots](#clips-and-screenshots)
    - [The activity feed](#the-activity-feed)
    - [Trending](#trending)
    - [Rich Presence](#rich-presence)
    - [Game Hubs](#game-hubs)
  - [Use the Xbox services Social APIs](#use-the-xbox-services-social-apis)



## Bringing gamers together

Xbox is committed to building an active community of gamers.
...
Each gamer on Xbox services has a profile.
...
This lets all your friends on Xbox services know what you've been up to, with the special added benefit of giving your game more exposure for every player getting in the game.

The following features help Xbox players discover your game and keep them engaged after they've become yet another loyal fan.
...
Players will be able to record gameplay videos and screenshots to share with their friends on Xbox services.
...
The most popular content published across Xbox services is visible in the Trending section of Xbox services.
If a gamer posts an interesting question on your Game Hub or shares a great clip of your game, you can expect your content to trend on Xbox services.
...
By integrating with Xbox services, your game automatically gets a hub page known as the Game Hub.
Game Hub is the official destination for your game on Xbox network, and lets players find game-related activity, Achievements, groups, Clubs, tournaments, and more.
...
To keep gamers and their friends engaged with your title through the Xbox services Social APIs, use the `SocialManager` class;
