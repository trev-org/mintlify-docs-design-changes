...
Determines whether the network is currently initialized.  For more information, see the [Network Initialization](../../../../features/console/networking/initialization-connectivity-networking.md#ID4ETA) section of [Retrieving network information](../../../../features/console/networking/initialization-connectivity-networking.md).
