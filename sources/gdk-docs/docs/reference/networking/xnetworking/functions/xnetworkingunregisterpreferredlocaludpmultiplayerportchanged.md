...
> [!NOTE]
> This function is safe to call on a time-sensitive thread only if the *wait* parameter is false. For more information, see [Time-sensitive threads](../../../../gdk-dev/console-dev/overviews/threads/time-sensitive-threads.md).  
...
> [!NOTE]
> This function should not be called from within an [XNetworkingPreferredLocalUdpMultiplayerPortChangedCallback](xnetworkingpreferredlocaludpmultiplayerportchangedcallback.md) if *wait* is true since this will deadlock.
...
[Preferred local UDP multiplayer port networking APIs](../../../../features/console/networking/game-mesh/preferred-local-udp-multiplayer-port-networking.md)  
