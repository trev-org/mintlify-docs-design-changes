...
title: IGameInput::RegisterDeviceCallback
---
...
The function registered by **IGameInput::RegisterDeviceCallback** can be used to react to changes of state in the device, such as a connect or disconnect. The types of recognizable state changes are listed in [GameInputDeviceStatus](../../../enums/gameinputdevicestatus.md).
