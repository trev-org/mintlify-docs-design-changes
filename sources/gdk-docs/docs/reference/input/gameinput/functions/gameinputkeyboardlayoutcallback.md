---
author: AlexYatskov
description: Title-defined callback for keyboard layout change events.
edited: 03/06/2025
kindex: GameInputKeyboardLayoutCallback
ms.author: alyatsko
ms.date: 03/06/2025
ms.topic: reference
permissioned-type: public
title: GameInputKeyboardLayoutCallback
---
...
The callback token returned by [IGameInput::RegisterKeyboardLayoutCallback](../interfaces/igameinput/methods/igameinput_registerkeyboardlayoutcallback.md).

*context* &nbsp;&nbsp;\_In\_\
Type: void*

The title defined context passed to [IGameInput::RegisterKeyboardLayoutCallback](../interfaces/igameinput/methods/igameinput_registerkeyboardlayoutcallback.md).
