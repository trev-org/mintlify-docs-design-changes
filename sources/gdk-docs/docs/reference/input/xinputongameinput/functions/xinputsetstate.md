...
description: "Sends vibration data to the specified two-motor controller."
...
This function supports older controllers which have only two haptic feedback motors. To support additional feedback motors in newer controllers, call [XInputSetStateEx](xinputsetstateex.md).  
