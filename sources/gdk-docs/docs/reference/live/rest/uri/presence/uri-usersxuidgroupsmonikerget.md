...
Retrieves the users in the group specified by the moniker related to the user in the URI, and returns the PresenceRecord for those users. Data that is gated by Privacy or Content Isolation will simply not be returned.
