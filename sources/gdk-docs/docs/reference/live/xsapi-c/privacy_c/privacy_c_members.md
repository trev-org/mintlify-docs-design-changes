...
| [XblPrivacyListChangeType](enums/xblprivacylistchangetype.md) | Defines the type of change that occurred on a privacy list. |  
...
| --- | --- |  
| [XblPrivacyAddBlockListChangedHandler](functions/xblprivacyaddblocklistchangedhandler.md) | Registers an event handler for notifications when the user's block list changes. |  
| [XblPrivacyAddMuteListChangedHandler](functions/xblprivacyaddmutelistchangedhandler.md) | Registers an event handler for notifications when the user's mute list changes. |  
...
| [XblPrivacyRemoveBlockListChangedHandler](functions/xblprivacyremoveblocklistchangedhandler.md) | Removes a block list change handler. |  
| [XblPrivacyRemoveMuteListChangedHandler](functions/xblprivacyremovemutelistchangedhandler.md) | Removes a mute list change handler. |  
...
| [XblPrivacyBlockListChangeEventArgs](structs/xblprivacyblocklistchangeeventargs.md) | Event arguments for a block list change. |  
| [XblPrivacyMuteListChangeEventArgs](structs/xblprivacymutelistchangeeventargs.md) | Event arguments for a mute list change. |  