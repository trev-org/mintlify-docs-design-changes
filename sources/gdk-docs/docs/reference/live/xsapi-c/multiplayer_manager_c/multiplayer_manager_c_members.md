...
| [XblMultiplayerManagerLobbySessionLastTournamentTeamResult](functions/xblmultiplayermanagerlobbysessionlasttournamentteamresult.md) | The known last team result of the tournament. Only applicable if you are using Xbox Live Tournaments. |  
