...
UTF-8 encoded JSON values for each column in the leaderboard row for the player. This will include the corresponding [XblLeaderboardQuery](xblleaderboardquery.md)'s **statName**, followed by any of the specified **additionalColumnleaderboardNames** that exist in the row.
