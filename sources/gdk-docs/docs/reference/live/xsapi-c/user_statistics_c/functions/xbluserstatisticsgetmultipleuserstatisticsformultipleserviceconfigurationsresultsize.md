...
description: "Get the result size for an XblUserStatisticsGetMultipleUserStatisticsForMultipleServiceConfigurationsResult call."
...
Get the result size for an XblUserStatisticsGetMultipleUserStatisticsForMultipleServiceConfigurationsResult call.
