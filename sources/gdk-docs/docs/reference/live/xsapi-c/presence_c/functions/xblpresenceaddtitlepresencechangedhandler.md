...
description: "Registers an event handler for title presence change notifications. Notifications will only be received for the Users and Titles configured with XblPresenceTrackUsers and XblPresenceTrackAdditionalTitles respectively."
