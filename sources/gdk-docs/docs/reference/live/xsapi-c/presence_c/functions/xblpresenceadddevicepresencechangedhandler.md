...
description: "Registers an event handler for device presence change notifications. Notifications will only be received for the Users configured with XblPresenceTrackUsers."
