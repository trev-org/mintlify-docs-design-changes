...
| [XblMultiplayerSearchHandleGetSessionClosed](functions/xblmultiplayersearchhandlegetsessionclosed.md) | Get whether or not the session associated with the search handle is temporarily closed for joining. |  
...
| [XblMultiplayerSessionArbitrationServer](functions/xblmultiplayersessionarbitrationserver.md) | An arbitration server that contains properties associated with a tournament games results. |  
| [XblMultiplayerSessionArbitrationStatus](functions/xblmultiplayersessionarbitrationstatus.md) | Arbitration status of a tournament. |  
...
| [XblMultiplayerSessionTournamentsServer](functions/xblmultiplayersessiontournamentsserver.md) | A tournament session servers that contains properties associated with a tournament reference. |  
...
| [XblNetworkAddressTranslationSetting](enums/xblnetworkaddresstranslationsetting.md) | Defines values that indicate the current network address translation (NAT) settings for a console connecting to {% term xbox-live %}.|  
