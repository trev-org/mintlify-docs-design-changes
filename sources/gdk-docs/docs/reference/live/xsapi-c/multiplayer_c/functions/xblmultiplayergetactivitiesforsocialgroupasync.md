...
description: "DEPRECATED - Call XblMultiplayerGetActivitiesWithPropertiesForSocialGroupAsync, which also populates `CustomSessionProperties` in the result.<br /> Queries for the current activity for a social group of players associated with a particular \"owner\" player."
