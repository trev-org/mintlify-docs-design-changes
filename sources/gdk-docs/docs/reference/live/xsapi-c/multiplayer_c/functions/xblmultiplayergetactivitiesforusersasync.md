...
description: "DEPRECATED - Call XblMultiplayerGetActivitiesWithPropertiesForUsersAsync, which also populates `CustomSessionProperties` in the result. Queries for the current activity for a set of players specified by Xbox user ID."
