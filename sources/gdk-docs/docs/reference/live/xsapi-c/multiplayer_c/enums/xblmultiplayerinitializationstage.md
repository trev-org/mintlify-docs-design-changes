...
For more information about managed initialization, see the "Managed initialization" section of [Target session initialization and QoS](../../../../../services/multiplayer/matchmaking/concepts/live-matchmaking-target-session.md).
