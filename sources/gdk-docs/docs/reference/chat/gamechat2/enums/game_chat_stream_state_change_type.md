...
description: "Defines the types of game_chat_stream_state_change objects that can be reported by chat_manager::start_processing_stream_state_changes."
