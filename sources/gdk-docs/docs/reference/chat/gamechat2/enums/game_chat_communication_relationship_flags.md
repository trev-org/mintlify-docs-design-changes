...
For more information about initializing and working with a chat instance, see [Using the Game Chat 2 C++ API](../../../../services/multiplayer/chat/game-chat2/using-game-chat-2.md).  
