...
For more information about processing data frames, see the [Processing data frames](../../../../services/multiplayer/chat/game-chat2/using-game-chat-2.md#processing_data_frames) section in [Using the Game Chat 2 C++ API](../../../../services/multiplayer/chat/game-chat2/using-game-chat-2.md).  
