...
description: "Defines the extra adjustment steps applied by Game Chat 2 to a communication relationship that was previously set by calling chat_user_local::set_communication_relationship."
