...
For more information about manipulating chat audio data, see [Real-time audio manipulation](../../../../services/multiplayer/chat/game-chat2/real-time-audio-manipulation.md).  
