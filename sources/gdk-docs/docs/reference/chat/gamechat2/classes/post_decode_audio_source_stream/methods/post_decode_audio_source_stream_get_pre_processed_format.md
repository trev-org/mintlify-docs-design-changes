---
author: M-Stahl
title: "post_decode_audio_source_stream::get_pre_processed_format"
description: "Gets the audio format of the buffers that are returned by post_decode_audio_source_stream::get_next_buffer."
