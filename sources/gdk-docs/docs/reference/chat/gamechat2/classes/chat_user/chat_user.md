---
author: M-Stahl
title: "chat_user class"
description: "Represents an individual local or remote user that has been added to the local chat_manager instance."
kindex: chat_user
ms.author: jkepner
ms.topic: reference
ms.date: '09/13/2019'
...
| [local function](methods/chat_user_local_function-overloads.md) | Returns a pointer to the [chat_user_local](chat_user_local/chat_user_local.md) object associated with this user, if the user is local. |  
...
For more information about working with users in Game Chat 2, see the [Configuring users](../../../../../services/multiplayer/chat/game-chat2/using-game-chat-2.md#configuring_users) section of [Using the Game Chat 2 C++ API](../../../../../services/multiplayer/chat/game-chat2/using-game-chat-2.md).  
