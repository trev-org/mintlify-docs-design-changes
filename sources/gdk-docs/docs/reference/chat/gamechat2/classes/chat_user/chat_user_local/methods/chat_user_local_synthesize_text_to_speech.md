...
This method synthesizes the text message specified in `message` as audio, generating packets as if the audio came from the local user's microphone. For more information about text-to-speech, see [Using the Game Chat 2 C++ API](../../../../../../../services/multiplayer/chat/game-chat2/using-game-chat-2.md).  
