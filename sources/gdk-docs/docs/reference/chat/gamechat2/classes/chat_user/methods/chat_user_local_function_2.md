...
author: M-Stahl
title: "local const"
description: "Returns a `const` pointer to the chat_user_local object associated with this user, if the user is local."
kindex: local
ms.author: jkepner
ms.topic: reference
ms.date: '09/13/2019'
