---
author: M-Stahl
title: "pre_encode_audio_stream::get_pre_processed_format"
description: "Gets the audio format of the buffers that are returned by pre_encode_audio_stream::get_next_buffer."
...
For more information about manipulating pre-encode chat audio data, see [Real-time audio manipulation](../../../../../../services/multiplayer/chat/game-chat2/real-time-audio-manipulation.md).  
