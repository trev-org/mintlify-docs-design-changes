---
author: M-Stahl
title: "post_decode_audio_sink_stream::set_processed_format"
description: "Specifies the format of the processed audio that is submitted to Game Chat 2 for rendering through post_decode_audio_sink_stream::submit_mixed_buffer."
...
For more information about manipulating post-decode chat audio data, see [Real-time audio manipulation](../../../../../../services/multiplayer/chat/game-chat2/real-time-audio-manipulation.md).  
