...
| [get_thread_affinity_mask](methods/chat_manager_get_thread_affinity_mask.md) | Retrieves the current affinity mask representing the processor(s) on which internal Game Chat threads will run or are running. |  
...
| [set_thread_affinity_mask](methods/chat_manager_set_thread_affinity_mask.md) | Optionally configures the processor on which internal Game Chat threads will run. |  
...
For more information about interacting with Game Chat 2, see [Using the Game Chat 2 C++ API](../../../../../services/multiplayer/chat/game-chat2/using-game-chat-2.md).  
