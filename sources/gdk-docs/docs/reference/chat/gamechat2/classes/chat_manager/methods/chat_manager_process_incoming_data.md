...
When the app's transport layer receives data that originated from a remote instance of Game Chat 2, call this method to deliver the data to the local instance of Game Chat 2. Game Chat 2 then decodes the incoming data and renders it to the local user's device. For more information about processing data frames, see [Using the Game Chat 2 C++ API](../../../../../../services/multiplayer/chat/game-chat2/using-game-chat-2.md).  
