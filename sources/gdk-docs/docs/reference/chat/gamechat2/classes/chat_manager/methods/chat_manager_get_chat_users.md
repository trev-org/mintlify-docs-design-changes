...
The individual `chat_user` objects remain valid until the user has been removed by a call to `chat_manager::remove_user`. For more information about initializing and cleaning up a chat instance, see [Using the Game Chat 2 C++ API](../../../../../../services/multiplayer/chat/game-chat2/using-game-chat-2.md).  
