...
description: "Represents information specific to the game_chat_state_change_type::communication_relationship_adjuster_changed state change."
...
For more information about processing state changes, see [Using the Game Chat 2 C++ API](../../../../services/multiplayer/chat/game-chat2/using-game-chat-2.md).  
