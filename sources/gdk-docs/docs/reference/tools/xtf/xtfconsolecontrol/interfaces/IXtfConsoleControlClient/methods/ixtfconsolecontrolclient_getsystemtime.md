...
This function retrieves the system date and time from the current development console as an [XTFSYSTEMTIME](../../../structs/xtfsystemtime.md) structure. The structure represents the system date and time in its various components, from year to millisecond. For more information about viewing the current system time on a development console, see [Developer Home on the console (Dev Home) (NDA topic)](../../../../../../../tools/tools-console/devhome/devhome.md).  
