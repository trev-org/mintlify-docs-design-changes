...
For more information about querying power mode options using Xbox Tools Framework (XTF), see [Reboot (xbreboot.exe) (NDA topic)](../../../../../../../tools/tools-console/commandlinetools/xbreboot.md).  
