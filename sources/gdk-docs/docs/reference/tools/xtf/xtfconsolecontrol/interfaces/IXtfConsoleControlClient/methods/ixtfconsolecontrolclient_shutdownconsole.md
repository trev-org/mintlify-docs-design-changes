...
For more information about shutting down and rebooting a console using Xbox Tools Framework (XTF), see [Reboot (xbreboot.exe) (NDA topic)](../../../../../../../tools/tools-console/commandlinetools/xbreboot.md).  
