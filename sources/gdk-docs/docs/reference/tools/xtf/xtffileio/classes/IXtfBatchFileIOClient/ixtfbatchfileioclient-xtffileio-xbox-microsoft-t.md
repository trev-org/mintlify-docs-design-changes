...
| Method | Description |  
| --- | --- |  
| [CopyFiles method](methods/copyfiles-ixtfbatchfileioclient-xtffileio-xbox-microsoft-m.md) | Batch-copies files between two locations on a development console and returns information about the operation. |  
