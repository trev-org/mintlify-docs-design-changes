...
For more information about how to use Xbox Tools Framework (XTF) to constrain and unconstrain an app for testing, see [Application Management (xbapp.exe) (NDA topic)](../../../../../../../tools/tools-console/commandlinetools/xbapp.md).  
