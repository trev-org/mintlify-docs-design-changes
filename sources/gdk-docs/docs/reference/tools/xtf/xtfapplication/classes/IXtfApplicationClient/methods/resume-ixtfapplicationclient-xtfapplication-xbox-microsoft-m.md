...
) method or calling the `xbapp suspend` command from the Application Management tool. For more information about game life cycle states, see [Xbox Game Life Cycle (NDA topic)](../../../../../../../gdk-dev/console-dev/overviews/xbox-game-life-cycle.md).  
