...
| [DebugQuery](methods/ixtfapplicationclient-debugquery.md) | Queries whether debugging is enabled for the app package with the specified package moniker. |  
| [Deploy](methods/deploy-ixtfapplicationclient-xtfapplication-xbox-microsoft-m.md) | Deploys the specified app package. |  
| [DeployEx](methods/ixtfapplicationclient-deployex.md) | Deploys the specified app package. |  
| [DeployToTitleScratch](methods/ixtfapplicationclient-deploytotitlescratch.md) | Deploys the specified app package. |  
