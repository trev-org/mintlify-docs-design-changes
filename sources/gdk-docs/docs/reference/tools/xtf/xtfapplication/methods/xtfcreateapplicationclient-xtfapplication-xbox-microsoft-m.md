...
description: "Initializes a new instance of the IXtfApplicationClient interface for the development console with the specified address."
...
For more information about available tool and automation APIs, such as Xbox Tools Framework (XTF), see [Tool and automation APIs (NDA topic)](../../../../../gdk-dev/console-dev/debug/atoc-api-tools-dev-env.md).  
