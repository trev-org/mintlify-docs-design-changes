...
description: "Contains information about a development console in an IXtfConsoleManager instance."
...
For more information about querying development consoles, see [Connect (xbconnect.exe) (NDA topic)](../../../../../tools/tools-console/commandlinetools/xbconnect.md).  
