...
For more information about querying the default development console, see [Connect (xbconnect.exe) (NDA topic)](../../../../../tools/tools-console/commandlinetools/xbconnect.md).  
