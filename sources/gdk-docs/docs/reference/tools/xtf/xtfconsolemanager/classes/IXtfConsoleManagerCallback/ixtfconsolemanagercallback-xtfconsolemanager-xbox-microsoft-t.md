...
description: "Provides callbacks that are used when a development console in an IXtfConsoleManager instance is added or removed, or when the default development console is changed."
