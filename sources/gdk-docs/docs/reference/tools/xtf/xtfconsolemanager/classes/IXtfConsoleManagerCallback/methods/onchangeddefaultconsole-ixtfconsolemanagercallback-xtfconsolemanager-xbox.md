...
description: "Called when a development console is set as the default development console in an IXtfConsoleManager instance."
...
For more information about connecting and querying development consoles, see [Connect (xbconnect.exe) (NDA topic)](../../../../../../../tools/tools-console/commandlinetools/xbconnect.md).  
