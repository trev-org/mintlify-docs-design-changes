...
description: "Identifies the value to return from XtfGetConsoleFieldValue."
...
This enumeration indicates which console field value is returned by the [XtfGetConsoleFieldValue](../functions/xtfgetconsolefieldvalue-xbox-microsoft-m.md) function. Use the value returned in the `fieldType` parameter of that function to identify the type of the returned console field value. For more information about console settings, see [Managing console settings (NDA topic)](../../../../../tools/tools-console/xbom/manager-tool-console-settings.md).  
