...
This enumeration indicates the type of the console field value returned by the [XtfGetConsoleFieldValue](../functions/xtfgetconsolefieldvalue-xbox-microsoft-m.md) function. Use the value specified in the `field` parameter of that function to identify the returned console field value. For more information about console settings, see [Managing console settings (NDA topic)](../../../../../tools/tools-console/xbom/manager-tool-console-settings.md).  
