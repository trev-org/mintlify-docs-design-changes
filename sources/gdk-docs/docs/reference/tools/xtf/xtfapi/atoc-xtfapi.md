...
| --- | --- |  
| [XtfCloseConsoleInfoList](functions/xtfcloseconsoleinfolist-xbox-microsoft-m.md) | Frees resources associated with an **XtfConsoleInfo** object returned by XtfGetConsoleInfoList. |  
