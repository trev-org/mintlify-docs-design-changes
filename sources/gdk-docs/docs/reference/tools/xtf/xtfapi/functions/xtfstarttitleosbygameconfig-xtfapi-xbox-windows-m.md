...
For more information about the contents of a MicrosoftGame.config file, see [MicrosoftGame.config Overview](../../../../../features/common/game-config/MicrosoftGameConfig-Overview.md).
