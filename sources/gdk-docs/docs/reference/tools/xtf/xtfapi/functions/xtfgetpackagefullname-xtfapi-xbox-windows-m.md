...
You can also use the [XtfGetCountofAppUserModelIds](xtfgetcountofappusermodelids-xtfapi-xbox-windows-m.md) and [XtfGetAumid](xtfgetaumid-xtfapi-xbox-windows-m.md) functions to retrieve Application User Model IDs (AUMIDs) for a registered package. For more information about packages, see [Packaging](../../../../../features/common/packaging/gc-packaging-toc.md).  
