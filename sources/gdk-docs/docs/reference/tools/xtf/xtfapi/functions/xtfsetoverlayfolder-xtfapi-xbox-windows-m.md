...
[in] Pointer to a string that contains the overlay folder path. If overlayFolderPath is **null** then packageFullName is ignored and the Overlay Folder is reset (equivalent to [xbapp overlayfolder package_full_name /r (NDA topic)](../../../../../tools/tools-console/commandlinetools/xbapp.md)).
