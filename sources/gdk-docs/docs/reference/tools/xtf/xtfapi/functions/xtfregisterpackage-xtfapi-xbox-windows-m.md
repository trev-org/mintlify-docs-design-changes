...
You can also use [XtfUnregisterPackage](xtfunregisterpackage-xtfapi-xbox-windows-m.md) to unregister a package. For more information about managing applications, see [Application Management (xbapp.exe) (NDA topic)](../../../../../tools/tools-console/commandlinetools/xbapp.md).  
