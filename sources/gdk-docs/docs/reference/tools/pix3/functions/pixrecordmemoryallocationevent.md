...
See [PIX custom memory allocators (NDA topic)](../../../../tools/tools-console/pix/pix-custom-memory-allocators.md) for information about how data from custom allocations and frees is shown in memory captures.
...
[PIX custom memory allocators (NDA topic)](../../../../tools/tools-console/pix/pix-custom-memory-allocators.md)
