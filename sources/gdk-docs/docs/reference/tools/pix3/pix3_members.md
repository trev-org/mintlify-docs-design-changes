...
| [PIXGetPowerMetrics (NDA topic)](functions/pixgetpowermetrics.md) | Returns the current power load on Xbox Series consoles |  
...
| [PIXPowerMetrics (NDA topic)](structs/pixpowermetrics.md) | Parameter for PIXGetPowerMetrics |  
...
For more information, see [PIX GPU capture APIs (NDA topic)](pix3_gpu_captures.md).

## See also

[PIX overview (NDA topic)](../../../tools/tools-console/pix/pix.md)  
