...
Specifies the StoreId of the associated title or titles that this Downloadable Content Package (DLC) title belongs to. For more information, see [Downloadable Content Packages (DLCs)](../../../../features/common/packaging/packaging-downloadable-content-dlc.md)
