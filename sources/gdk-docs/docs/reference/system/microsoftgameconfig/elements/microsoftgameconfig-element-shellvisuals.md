...
* SplashScreenImage attribute is not required for PC titles but is recommended as a best practice.
...
Square150x150Logo, Square44x44Logo, and StoreLogo are required for a non-DLC package on both PC and Console. SplashScreenImage is required for Console but is now, as of the February 2021 GDK, optional for PC. For DLC packages, only StoreLogo is required.
