...
List of Language Locale pairs used to localize Shell Visuals. May be copied and pasted from an existing AppxManifest as the format is retained.  For more information, see [Packaging](../../../../features/common/packaging/gc-packaging-toc.md).
