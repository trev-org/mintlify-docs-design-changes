...
A file-sourced queue accepts only file-sourced requests. A memory-sourced queue accepts only memory-sourced requests. For more information, see the "Memory-to-memory decompression" section of [DirectStorage Overview](../../../../features/console/storage/directstorage/directstorage-overview.md). 
