...
For more information, see "SetCPUAffinity" in the "IDStorageFileX" section in [DirectStorage Overview](../../../../../../features/console/storage/directstorage/directstorage-overview.md). 
