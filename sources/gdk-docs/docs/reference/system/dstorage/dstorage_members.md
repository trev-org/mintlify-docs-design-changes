...
| [IDStorageFactoryX2](interfaces/IDStorageFactoryX2/idstoragefactoryx2.md) | Represents the static DirectStorage factory object. |  
...
| [IDStorageQueueX1](interfaces/IDStorageQueueX1/idstoragequeuex1.md) | Represents a DirectStorage queue. |  
| [IDStorageQueueX2](interfaces/IDStorageQueueX2/idstoragequeuex2.md) | Represents a DirectStorage queue. |  
...
| [DSTORAGE_PRIORITY_STATS data structure](structs/dstorage_priority_stats.md) | DirectStorage per priority statistics. |  
| [DSTORAGE_QUEUE_DESC](structs/dstorage_queue_desc.md) | Properties of a DirectStorage queue. |  
| [DSTORAGE_QUEUE_DESC1](structs/dstorage_queue_desc1.md) | Properties of a DirectStorage queue. |  
| [DSTORAGE_QUEUE_INFO](structs/dstorage_queue_info.md) | Properties and current state of a DirectStorage queue. |  
| [DSTORAGE_QUEUE_INFO1](structs/dstorage_queue_info1.md) | Properties and current state of a DirectStorage queue. |  
| [DSTORAGE_QUEUE_OPTIONS](structs/dstorage_queue_options.md) | Options for a DirectStorage queue creation. |  
