...
![Customizing wheels by the player](../../../../../media/public-images/game-streaming/touch-control-images/game-streaming-touch-control-images-wheel-ergo.jpg)
...
![Wheel with joystick in inner slot and custom buttons in each outer slot](../../../../../media/public-images/game-streaming/touch-control-images/game-streaming-touch-control-images-wheel-example.png)
...
![Wheel with joystick in inner slot and custom buttons in each outer slot](../../../../../media/public-images/game-streaming/touch-control-images/game-streaming-touch-control-images-wheel-left-dpad.png)
...
![Wheel with joystick in inner slot and custom buttons in each outer slot](../../../../../media/public-images/game-streaming/touch-control-images/game-streaming-touch-control-images-wheel-right.png)
