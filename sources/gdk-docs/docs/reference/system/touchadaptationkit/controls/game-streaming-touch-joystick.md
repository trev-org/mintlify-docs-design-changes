...
![User interacting with a joystick](../../../../../media/public-images/game-streaming/touch-control-images/game-streaming-touch-control-images-joystick.gif)
...
![User interacting with a joystick that has an action threshold](../../../../../media/public-images/game-streaming/touch-control-images/game-streaming-touch-control-images-joystick-with-threshold-action.gif)
...
![User interacting with a horizontal steering wheel joystick](../../../../../media/public-images/game-streaming/touch-control-images/game-streaming-touch-control-images-joystick-driving.gif)
...
![User interacting with a joystick with customized colors](../../../../../media/public-images/game-streaming/touch-control-images/game-streaming-touch-control-images-joystick-customized-colors.gif)
