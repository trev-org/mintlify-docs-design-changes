...
| [XStoreAcquireLicenseForPackageAsync](functions/xstoreacquirelicenseforpackageasync.md) | Acquires a license for a game's DLC that the user is entitled to use. |  
...
| [XStoreQueryAssociatedProductsForStoreIdAsync](functions/xstorequeryassociatedproductsforstoreidasync.md) | Gets store listing information for the products that can be purchased from the product specified by the Store ID. |  
| [XStoreQueryAssociatedProductsForStoreIdResult](functions/xstorequeryassociatedproductsforstoreidresult.md) | Gets the results for a call to [XStoreQueryAssociatedProductsForStoreIdAsync](functions/xstorequeryassociatedproductsforstoreidasync.md). |  
...
| [XStoreQueryPackageUpdatesAsync](functions/xstorequerypackageupdatesasync.md) | Retrieves the available updates for the packages specified. |  
| [XStoreQueryPackageUpdatesResult](functions/xstorequerypackageupdatesresult.md) | Gets the result for a call to [XStoreQueryPackageUpdatesAsync](functions/xstorequerypackageupdatesasync.md). |  
| [XStoreQueryPackageUpdatesResultCount](functions/xstorequerypackageupdatesresultcount.md) | Gets the number of updates retrieved by [XStoreQueryPackageUpdatesAsync](functions/xstorequerypackageupdatesasync.md). |  
...
| [XStoreShowGiftingUIAsync](functions/xstoreshowgiftinguiasync.md) | Allows the game to request purchasing a particular store product as a gift for another user. |  
| [XStoreShowGiftingUIResult](functions/xstoreshowgiftinguiresult.md) | Gets the results of a call to [XStoreShowGiftingUIAsync](functions/xstoreshowgiftinguiasync.md). |  
...
| --- | --- |  
| [XStoreAddonLicense](structs/xstoreaddonlicense.md) | Describes an add-on license. |  
...
[Commerce Overview](../../../store/commerce/commerce-nav.md)