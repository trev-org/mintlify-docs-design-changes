...
Provides an opaque JSON Web Token to the calling game that can be passed to the game's service for validation of entitlement and to make B2B calls. See [License Tokens Overview](../../../../store/commerce/pc-specific-considerations/xstore-license-tokens.md) for more information.
