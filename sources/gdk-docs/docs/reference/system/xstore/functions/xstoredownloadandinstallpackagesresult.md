...
description: "Gets the results for a call to XStoreDownloadAndInstallPackagesAsync."
...
On success contains a list of package identifiers for the packages that were downloaded. For more information about package identifiers, see [Manage and license downloadable content (DLC)](../../../../store/commerce/fundamentals/xstore-manage-and-license-optional-packages.md).  
