...
description: "Properties that can be queried for on the client streaming device."
...
| DisplayDetails | The display details of the client. | [XGameStreamingGetDisplayDetails](../functions/xgamestreaminggetdisplaydetails.md) |
