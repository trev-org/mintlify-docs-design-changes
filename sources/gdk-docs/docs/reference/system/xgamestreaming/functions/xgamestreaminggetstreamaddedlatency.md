...
`XGameStreamingGetStreamAddedLatency` is an average measurement which is updated every few seconds.  For more precise measurements, the [XGameStreamingGetAssociatedFrame](xgamestreaminggetassociatedframe.md) API may be used. See [Game streaming latency compensation deep dive](../../../../features/common/game-streaming/game-streaming-latency-compensation-deep-dive.md) for more information.
