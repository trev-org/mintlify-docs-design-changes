...
The maximum size in bytes of the `versionName` to be returned.  The size that is specified can be found by calling [XGameStreamingGetTouchBundleVersionNameSize](xgamestreaminggettouchbundleversionnamesize.md).
