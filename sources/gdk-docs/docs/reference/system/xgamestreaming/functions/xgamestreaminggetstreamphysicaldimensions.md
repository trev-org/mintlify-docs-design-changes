...
This allows you to present a more player friendly, device&ndash;appropriate experience (for example, by using a larger font size) based on the device size.
