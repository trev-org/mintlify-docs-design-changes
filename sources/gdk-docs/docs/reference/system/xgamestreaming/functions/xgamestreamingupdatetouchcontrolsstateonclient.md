...
| E_INVALIDARG | 0x80070057  | if a specified operation does not have data that matches the data type specified in the operations [XGameStreamingTouchControlsStateValueKind](../enums/xgamestreamingtouchcontrolsstatevaluekind.md) |   
