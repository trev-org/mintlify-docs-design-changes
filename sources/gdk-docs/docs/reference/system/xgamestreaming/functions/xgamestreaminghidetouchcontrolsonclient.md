...
description: "Request that a specified streaming client device hide the touch layout if it is visible."
...
If your game needs to hide the touch control layout on **all** connected streaming client devices, consider using [XGameStreamingHideTouchControls](xgamestreaminghidetouchcontrols.md) instead.
