...
description: "Specifies the preferred mode to use when calling XDisplayTryEnableHdrMode."
...
For more information about HDR support, see [High Dynamic Range (HDR) output (NDA topic)](../../../../features/graphics/overviews/hdr-support.md).
...
[High dynamic range (HDR) output (NDA topic)](../../../../features/graphics/overviews/hdr-support.md)  
