...
![alert](../../../../../media/public-images/common/note.gif) **Performance Note:**  
...
> [!NOTE] 
> **SubmitCallback** is a helper function that is defined in the code example for the [XTaskQueueSubmitCallback](xtaskqueuesubmitcallback.md) function.  
