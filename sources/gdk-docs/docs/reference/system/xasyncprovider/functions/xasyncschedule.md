...
For an example of an asynchronous provider that uses `XAsyncSchedule` to schedule asynchronous work, see the "Async Library" section in [Asynchronous Programming Model](../../../../features/common/async/async-programming-model.md#heading-7).  
