...
description: "This method shows a picker UI populated from the requesting player's friend list and suggested friend list to send out game invites for titles using the Multiplayer Activity service."
