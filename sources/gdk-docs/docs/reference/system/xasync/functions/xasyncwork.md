...
author: M-Stahl
title: "XAsyncWork"
description: "Represents the callback function invoked by XAsyncRun."
kindex: XAsyncWork
ms.topic: reference
edited: 06/19/2019
applies-to: pc-gdk
...
For more information about `XAsyncProvider` functionality, see [Asynchronous Programming Model](../../../../features/common/async/async-programming-model.md).  
