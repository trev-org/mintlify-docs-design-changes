...
For more information about implementing your own asynchronous functionality with `XAsyncProvider` and `XAsyncBlock`, see [Asynchronous Programming Model](../../../../features/common/async/async-programming-model.md).  
