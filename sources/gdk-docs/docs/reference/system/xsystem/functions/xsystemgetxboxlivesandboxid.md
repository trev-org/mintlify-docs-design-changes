...
see [Time-sensitive threads](../../../../gdk-dev/console-dev/overviews/threads/time-sensitive-threads.md).  
...
## See also  
[Configuring dev kit settings (NDA topic)](../../../../gdk-dev/console-dev/dev-kits/settings/config-dev-kit-settings.md)  
[Setting up sandboxes for Xbox Live development](../../../../services/fundamentals/sandboxes/live-setting-up-sandboxes.md)  
