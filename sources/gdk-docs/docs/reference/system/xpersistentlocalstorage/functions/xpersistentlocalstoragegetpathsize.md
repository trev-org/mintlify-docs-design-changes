...
The return value of this function is used for the *pathSize* parameter of the [XPersistentLocalStorageGetPath](xpersistentlocalstoragegetpath.md) function to return the game-specific PLS path on the device. For more information about PLS, see [Local Storage](../../../../features/console/storage/local-storage.md).  
