...
| [XPackageMount](functions/xpackagemount.md) | This function is now deprecated. Use XPackageMountWithUiAsync instead. |  
| [XPackageMountWithUiAsync](functions/xpackagemountwithuiasync.md) | Asynchronously mounts the installation of specified content, and returns a mount handle to it. |  
| [XPackageMountWithUiResult](functions/xpackagemountwithuiresult.md) | Gets the results of a call to XPackageMountWithUIAsync. |  
...
| [XPackageUninstallPackage](functions/xpackageuninstallpackage.md) | Uninstalls a given package. |  
