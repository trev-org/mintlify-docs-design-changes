...
description: "Gets the size required for an array to hold a mount path returned by XPackageGetMountPath."
...
[XPackageGetMountPath](xpackagegetmountpath.md) mounts the specified package identifier and returns a mount handle to it. This might take several seconds. For more information about package identifiers, see [Manage and license downloadable content (DLC)](../../../../store/commerce/fundamentals/xstore-manage-and-license-optional-packages.md). 
