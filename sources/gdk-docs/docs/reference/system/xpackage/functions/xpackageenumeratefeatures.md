...
The package to enumerate the features of the layout file. For more information about package 
identifiers, see [Manage and license downloadable content (DLC)]
(xstore-manage-and-license-optional-packages.md).    
...
*callback* &nbsp;&nbsp;\_In\_  
Type: [XPackageFeatureEnumerationCallback](xpackagefeatureenumerationcallback.md)*  
...
includes the ``displayName`` for that feature which it is shown in the *Shell* manage page for the 
game. For information about the packaging technology used with Xbox One titles, see [Overview of 
Packaging](../../../../features/common/packaging/overviews/packaging.md). 
