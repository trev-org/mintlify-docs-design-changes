...
description: "Sets the callback function for XAppBroadcastRegisterIsAppBroadcastingChanged. The function set here will be called each time the broadcast status changes."
