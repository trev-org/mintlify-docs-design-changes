...
> [!NOTE] 
> *XUserFindForDevice* cannot return a user handle to a user that hasn't been signed in with a call to [XUserAddAsync](xuseraddasync.md). See [Users and input devices](../../../../features/common/user/users-input-devices.md) for more information.
