...
![Front panel display of the Xbox One X](../../../../../media/public-images/front_panel_display_small.png)  
...
For more information, see [Xbox One X: Using the front panel display (NDA topic)](../../../../gdk-dev/console-dev/dev-kits/concepts/scorpio-frontpanel.md).  
