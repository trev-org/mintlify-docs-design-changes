---
author: AlexYatskov
description: "Retrieves the previous IGameInputReading based on a reference reading from an optionally filtered input stream (v1)."
edited: "03/06/2025"
kindex: "GetPreviousReading (v1)"
ms.author: alyatsko
ms.date: "03/06/2025"
ms.topic: reference
permissioned-type: public
title: "IGameInput::GetPreviousReading (v1)"
---

# IGameInput::GetPreviousReading (v1)

Retrieves the previous [IGameInputReading](../../igameinputreading/igameinputreading-v1.md) based on a reference reading from an optionally filtered input stream.
...
The [GetNextReading](igameinput_getnextreading-v1.md) and [GetPreviousReading](igameinput_getpreviousreading-v1.md) methods let apps walk through the input history reading by reading.
