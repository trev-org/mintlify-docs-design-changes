---
author: AlexYatskov
description: "Registers a callback for Guide and Share buttons (v1)."
edited: "03/06/2025"
kindex: "RegisterSystemButtonCallback (v1)"
ms.author: alyatsko
ms.date: "03/06/2025"
ms.topic: reference
permissioned-type: public
title: "RegisterSystemButtonCallback (v1)"
---

# IGameInput::RegisterSystemButtonCallback (v1)
...
This method registers a callback function call when the Guide or System button is pressed or released. Whether callbacks are dispensed depends on the [GameInputFocusPolicy](../../../enums/gameinputfocuspolicy-v1.md) set by [IGameInput::SetFocusPolicy](igameinput_setfocuspolicy-v1.md) in your process and other processes. See [GameInputFocusPolicy](../../../enums/gameinputfocuspolicy-v1.md) for details. On the Xbox, the shell always consumes the guide button, so these callbacks are never dispatched on Xbox.

To stop receiving callbacks, see the [IGameInput::UnregisterCallback](igameinput_unregistercallback-v1.md) and [IGameInput::StopCallback](igameinput_stopcallback-v1.md) methods.
