---
author: AlexYatskov
description: "IGameInput::RegisterDeviceCallback API reference (v1)."
edited: "03/06/2025"
kindex: "IGameInput::RegisterDeviceCallback (v1)"
ms.author: alyatsko
ms.date: "03/06/2025"
ms.topic: reference
permissioned-type: public
title: "IGameInput::RegisterDeviceCallback (v1)"
---

# IGameInput::RegisterDeviceCallback (v1)
...
Type: [GameInputEnumerationKind](../../../enums/gameinputenumerationkind-v1.md)
...
*callbackFunc* &nbsp;&nbsp;\_In\_\
Type: [GameInputDeviceCallback](../../../functions/gameinputdevicecallback-v1.md)
...
The function registered by **IGameInput::RegisterDeviceCallback** can be used to react to changes of state in the device, such as a connect or disconnect. The types of recognizable state changes are listed in [GameInputDeviceStatus](../../../enums/gameinputdevicestatus-v1.md).
