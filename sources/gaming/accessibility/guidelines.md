...
description: Game development documentation for creating accessible games.
ms.topic: article
ms.date: 06/08/2023
---

# Xbox Accessibility Guidelines V3.2
Version 3.2 was published on Jun 8, 2023. To view guideline change history, see [Xbox Accessibility Guidelines version history](xag-version-history.md).
...
_Thank you to the developers and publishers who have graciously approved the use of their game content to be published in these guidelines._
...
|:-----------:|:-------------|
| [101](xbox-accessibility-guidelines/101.md) | Text display |
| [102](xbox-accessibility-guidelines/102.md) | Contrast |
| [103](xbox-accessibility-guidelines/103.md) | Additional channels for visual and audio cues |
| [104](xbox-accessibility-guidelines/104.md) | Subtitles and captions |
| [105](xbox-accessibility-guidelines/105.md) | Audio accessibility |
| [106](xbox-accessibility-guidelines/106.md) | Screen narration |
| [107](xbox-accessibility-guidelines/107.md) | Input |
| [108](xbox-accessibility-guidelines/108.md) | Game difficulty options |
| [109](xbox-accessibility-guidelines/109.md) | Object clarity |
| [110](xbox-accessibility-guidelines/110.md) | Haptic feedback |
| [111](xbox-accessibility-guidelines/111.md) | Audio description |
| [112](xbox-accessibility-guidelines/112.md) | UI navigation |
| [113](xbox-accessibility-guidelines/113.md) | UI focus handling |
| [114](xbox-accessibility-guidelines/114.md) | UI context |
| [115](xbox-accessibility-guidelines/115.md) | Error messages and destructive actions |
| [116](xbox-accessibility-guidelines/116.md) | Time limits |
| [117](xbox-accessibility-guidelines/117.md) | Visual distractions and motion settings|
| [118](xbox-accessibility-guidelines/118.md) | Photosensitivity |
| [119](xbox-accessibility-guidelines/119.md) | Speech-to-text/text-to-speech chat |
| [120](xbox-accessibility-guidelines/120.md) | Communication experiences |
| [121](xbox-accessibility-guidelines/121.md) | Accessible feature documentation |
| [122](xbox-accessibility-guidelines/122.md) | Accessible customer support |
| [123](xbox-accessibility-guidelines/123.md) | Mental health best practices |

## Developer resources

* [Gaming and Disability Player Experience Guide](gadpeg.md)
* [Gaming Accessibility Fundamentals Learning Path](gaf-info.md)
* [Microsoft Gaming Accessibility Testing Service](mgats.md)
* [Xbox Developer Programs](https://www.xbox.com/developers/id)

## See also

* [Xbox Accessibility](accessibility.md)